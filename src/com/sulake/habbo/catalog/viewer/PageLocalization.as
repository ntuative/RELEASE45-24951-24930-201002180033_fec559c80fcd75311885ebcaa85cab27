package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_167:Dictionary = new Dictionary();
      
      private static const const_745:Object = {"frontpage3":[7,8]};
      
      private static const const_1059:Array = ["ctlg_header_text","ctlg_description","ctlg_special_txt","ctlg_text_1","ctlg_text_2"];
      
      private static const const_744:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      {
         const_167["frontpage3"] = ["ctlg_txt3","ctlg_txt7"];
         const_167["info_pixels"] = ["ctlg_text_5","ctlg_text_7"];
         const_167["info_credits"] = ["ctlg_text_5","ctlg_text_7"];
         const_167["collectibles"] = ["ctlg_collectibles_link"];
         const_167["club1"] = ["ctlg_text_5"];
      }
      ...
      {
         if(param1 < var_787.length)
         {
            return var_787[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < var_546.length)
         {
            _loc2_ = String(var_546[param1]).replace("#","0x");
