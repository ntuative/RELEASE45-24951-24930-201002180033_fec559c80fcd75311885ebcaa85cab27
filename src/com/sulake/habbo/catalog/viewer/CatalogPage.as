package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_763:ICatalogViewer;
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         var_1325 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1325) as IWindowContainer;
         if(_window == null)
         {
      ...
      {
         return _localization.hasLinks(var_738);
      }
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            var_51.push(new ClubGiftWidget(_loc1_,var_78.getClubGiftController()));
         }
      ...
      {
         return _localization.getLinks(var_738);
      }
