package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_402.getWithIndex(var_191);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_75.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_75.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_75 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_402.getValue(_loc6_) == null)
            {
               var_402.add(_loc6_,new Map());
            }
            _loc8_ = var_402.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_402.getWithIndex(var_191);
         if(_loc4_ != null)
         {
