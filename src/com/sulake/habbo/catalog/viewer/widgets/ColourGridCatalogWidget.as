package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1284 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_285 = null;
         for each(_loc1_ in var_1283)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1284) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_699.width,var_699.height,true,0);
               _loc3_.bitmap.copyPixels(var_699,var_699.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1180.width,var_1180.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_961.width,var_961.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_961,var_961.rect,new Point(0,0),null,null,true);
