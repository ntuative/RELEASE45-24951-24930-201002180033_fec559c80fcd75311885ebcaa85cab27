package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1026 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1026 != null)
         {
            var_1026.addEventListener(WindowKeyboardEvent.const_642,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1026.text));
      }
   }
}
