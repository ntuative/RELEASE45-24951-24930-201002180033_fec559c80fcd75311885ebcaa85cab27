package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_530:IItemGridWindow;
      
      private var var_75:IBitmapWrapperWindow;
      
      private var var_1207:ITextWindow;
      
      private var var_1160:IScrollbarWindow;
      
      protected var var_1335:XML;
      
      private var var_1161:BitmapData;
      
      private var var_1208:ITextWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_530 != null)
         {
            ...
            var_530.destroyGridItems();
         }
         if(var_1160 != null)
         {
            var_1160.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1207.text = "${" + _loc3_.name + "}";
            var_1208.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1207.text = "${" + _loc2_.localizationId + "}";
            var_1208.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_362:
                  _loc4_ = var_1161.clone();
                  if(var_530 != null)
                  {
                     var_530.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_530,var_1160,var_1335);
                  }
                  break;
               ...
               case Offer.const_453:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_195:
                        ...
                        _loc4_ = new BitmapData(var_75.width,var_75.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_30,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_267,AvatarAction.const_592);
      ...
      {
         var_1207 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1208 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_75 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1395 = new Point(var_75.x,var_75.y);
         var_530 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1160 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_530 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1335 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1161 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_75);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_75.bitmap = new BitmapData(var_75.width,var_75.height,true,16777215);
         }
         var_75.bitmap.fillRect(var_75.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_75.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_75.invalidate();
         var_75.x = var_1395.x;
         var_75.y = var_1395.y;
         if(param2 != null)
