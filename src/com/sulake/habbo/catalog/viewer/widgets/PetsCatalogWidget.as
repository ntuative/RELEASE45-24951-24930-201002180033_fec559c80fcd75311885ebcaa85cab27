package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_409 >= var_293.length)
         {
            return "";
         }
         var petColor:IPetColor = var_293[var_409] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_583[var_1540] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_409 < 0 || var_409 > var_293.length)
         {
            var_409 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_547.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         events.addEventListener(WidgetEvent.const_804,onApproveNameResult);
         _loc5_ = var_547.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_547.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_409 >= 0 && var_409 < var_293.length)
         {
            _loc7_ = var_293[var_409] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_583[var_1540] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_872,_loc3_.id,_loc2_,AvatarScaleType.const_34);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_267,AvatarAction.const_527);
