package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1206:MarketPlaceOfferData;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_383)
         {
            var_383 = new Timer(25);
            var_383.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_789 = 0;
         populateList();
         var_383.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_547)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      override public function dispose() : void
      {
         ...
         if(var_383)
         {
            var_383.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_383 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_789 >= var_547.length)
            {
               return true;
            }
            addListItem(var_547.getWithIndex(var_789));
            ++var_789;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1206.offerId);
                  hideDetails();
            }
            return;
         }
