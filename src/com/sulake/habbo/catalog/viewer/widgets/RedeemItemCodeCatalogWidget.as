package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1015 != null)
         {
            var_1015.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1014 != null)
         {
            var_1014.removeEventListener(WindowKeyboardEvent.const_117,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1015 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1015 != null)
         {
            var_1015.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1014 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1014 != null)
         {
            var_1014.addEventListener(WindowKeyboardEvent.const_117,windowKeyEventProcessor);
         }
      }
