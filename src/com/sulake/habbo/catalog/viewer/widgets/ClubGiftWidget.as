package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateList() : void
      {
         ...
         for each(_loc6_ in _loc1_)
         {
            ...
            if(_loc4_)
            {
               ...
               var_547.add(_loc5_.offerId,_loc5_);
            }
         }
      }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!var_186)
         {
            var_186 = createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!var_186)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = var_186.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         var_186.setGlobalPosition(_loc6_.subtract(new Point(0,0)));
      ...
      {
         if(!param1 || !param2 || !var_547 || !_controller)
         {
            return;
         }
         ...
         var _loc3_:Offer = var_547.getValue(param2.id) as Offer;
         if(!_loc3_)
         {
            return;
         }
