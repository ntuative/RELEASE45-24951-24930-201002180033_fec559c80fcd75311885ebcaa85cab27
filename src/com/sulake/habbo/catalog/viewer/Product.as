package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1069:IProductData;
      ...
      {
         super();
         var_1071 = param1.productType;
         var_1070 = param1.furniClassId;
         var_896 = param1.extraParam;
         var_897 = param1.productCount;
         var_1068 = param1.expiration;
         var_1069 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_60:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_896);
               break;
