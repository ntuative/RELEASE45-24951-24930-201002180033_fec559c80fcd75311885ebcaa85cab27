package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_176:PurchaseConfirmationDialog;
      ...
      private var var_1810:GiftWrappingConfiguration;
      ...
      private var var_948:ClubGiftController;
      ...
      {
         return var_544.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_177.credits = _loc3_.balance;
         updatePurse();
         if(!var_1811 && var_816 != null)
         {
            var_816.playSound(HabboSoundTypesEnum.const_918);
         }
         var_1811 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_544.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_60)
         {
            _loc3_ = var_544.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_176.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_75:
               var_1162 = param1.session.isPrivateRoom;
               if(var_76 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1810 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_179 != null && _loc2_)
         {
            var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_181,false);
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_948.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_177.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_177.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_948 == null)
         {
            var_948 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_176 == null)
            {
               var_176 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_176.showOffer(this,param1,param2,param3,_loc7_);
      ...
      {
         var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_177.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_177.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_177.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_177.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_177.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1812 && var_816 != null)
         {
            var_816.playSound(HabboSoundTypesEnum.const_810);
         }
         var_1812 = false;
      }
