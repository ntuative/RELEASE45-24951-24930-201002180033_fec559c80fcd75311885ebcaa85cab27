package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_239:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_239.bitmap = new BitmapData(var_239.width,var_239.height,true,16777215);
         var_239.bitmap.fillRect(var_239.bitmap.rect,16777215);
         var _loc2_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_239.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
      }
      ...
      {
         var _loc8_:* = null;
         var_239 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
