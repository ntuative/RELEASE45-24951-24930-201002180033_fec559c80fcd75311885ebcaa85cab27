package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1025:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1358:XML;
      
      private static var var_1357:XML;
      ...
      private var var_1359:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1357 == null)
         {
            ...
            var_1357 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1359 == 4294967295)
            {
               var_1359 = _loc1_.color;
            }
            _loc1_.color = const_1025;
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1358) as IWindowContainer;
         }
         else
         {
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(var_43);
            }
         }
         if(var_43 != null)
         {
      ...
      {
         var_43 = navigator.catalog.windowManager.buildFromXML(var_1357) as IItemListWindow;
         if(var_43 == null)
         {
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(var_43);
            }
         }
         if(var_43 != null)
         {
