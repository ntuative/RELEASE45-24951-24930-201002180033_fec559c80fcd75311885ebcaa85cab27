package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2323:String = "magic.pixels";
      
      private var var_2324:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_258 = [];
         var_43 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_528,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_78.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_78.configuration.getKey("link.format.credits","/credits");
            var_78.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_78.openCatalogPage(var_2324,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_258.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_258)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_258.indexOf(_loc6_);
            var_258.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(var_258.indexOf(param1) == -1)
         {
            var_258.push(param1);
         }
         var_78.loadCatalogPage(param1.pageId);
         var_78.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_43);
            }
         }
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_78.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_78.loadCatalogPage(_loc2_.pageId);
         }
