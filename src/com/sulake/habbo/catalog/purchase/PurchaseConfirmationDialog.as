package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1384:uint = 4.294967295E9;
      
      private const const_1383:uint = 4.293848814E9;
      
      private var var_1221:int;
      
      private const const_1613:uint = 4.291613146E9;
      
      private var var_243:int = -1;
      ...
      public function receiverNotFound() : void
      {
         ...
         var_78.windowManager.alert("${catalog.gift_wrapping.receiver_not_found.title}","${catalog.gift_wrapping.receiver_not_found.info}",0,alertHandler);
      }
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         var _loc2_:XmlAsset = var_78.assets.getAssetByName(param1) as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return null;
         }
         return var_78.windowManager.buildFromXML(_loc2_.content as XML);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_795;
               }
            }
            _loc4_++;
         }
      ...
      {
         if(this.var_68 == null || this.var_68.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_78.getProductData(var_68.localizationId);
         var _loc2_:String = _loc1_ == null ? "" : _loc1_.name;
         var_78.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc2_);
         var _loc3_:String = "";
         var _loc4_:String = "";
         var _loc7_:String = var_78.getPurse().credits.toString();
         var _loc8_:String = var_78.getPurse().pixels.toString();
         switch(var_68.priceType)
         {
            case Offer.const_442:
               _loc6_ = "catalog.purchase.confirmation.dialog.price.credits";
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_68.priceInCredits.toString());
               _loc3_ = _loc5_.value;
            ...
            case Offer.const_435:
               ...
               _loc5_ = _localization.getLocalization(_loc6_);
               _localization.registerParameter(_loc6_,"credits",var_68.priceInCredits.toString());
               _localization.registerParameter(_loc6_,"pixels",var_68.priceInPixels.toString());
               _loc3_ = _loc5_.value;
               _localization.registerParameter(_loc6_,"credits",_loc7_);
         ...
         var_78.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc3_);
         var_78.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc4_);
      }
      ...
      private function updatePreview() : void
      {
         ...
         var _loc2_:IRoomEngine = var_68.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(var_795,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1383) : uint(const_1384);
      }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1455;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_78.getFurnitureData(_loc6_,ProductTypeEnum.const_56);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_78.purchaseProduct(var_670,var_68,var_988);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_243) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_795);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_550[var_183]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_551[var_182]);
         var_78.purchaseProductAsGift(var_670,var_68,var_988,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_78.getProductData(var_68.localizationId);
            _loc1_.text = _loc3_ == null ? "" : _loc3_.name;
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByName("product_image") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc4_ = var_68.page.viewer.roomEngine;
            _loc6_ = var_68.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_195:
                  _loc7_ = var_78.getPixelEffectIcon(_loc6_.productClassId);
                  break;
               case ProductTypeEnum.const_408:
                  _loc7_ = var_78.getSubscriptionProductIcon(_loc6_.productClassId);
            }
            if(_loc5_ != null)
            {
               _loc7_ = _loc5_.data;
      ...
      private function showGiftDialog() : void
      {
         ...
         var _loc1_:GiftWrappingConfiguration = var_78.giftWrappingConfiguration;
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1455 = _loc1_.stuffTypes;
            var_550 = _loc1_.boxTypes;
            var_551 = _loc1_.ribbonTypes;
            var_795 = var_1455[0];
            var_183 = var_550[0];
            var_182 = var_551[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_243) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_243);
         }
         var_243 = param1;
         if(var_243 < 0)
         {
            var_243 = _loc2_.numListItems - 1;
         }
         if(var_243 >= _loc2_.numListItems)
         {
            var_243 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_243) as IWindowContainer;
      ...
      private function setBitmapData(param1:IWindowContainer, param2:String, param3:String, param4:ColorTransform = null) : void
      {
         ...
         var _loc6_:BitmapDataAsset = var_78.assets.getAssetByName(param3) as BitmapDataAsset;
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_478 == null)
         {
            var_478 = createWindow("suggestion_list_item") as IWindowContainer;
            var_478.procedure = suggestionsEventHandler;
         }
         if(var_215 == null || var_478 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_215.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_478.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
