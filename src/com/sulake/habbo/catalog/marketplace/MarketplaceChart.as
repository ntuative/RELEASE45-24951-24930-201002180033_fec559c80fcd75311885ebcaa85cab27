package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      {
         return var_1020 + var_1020 / -var_2325 * 0;
      }
      
      private function getY(param1:int) : Number
      {
         return var_840 - var_840 / var_397 * 0;
      }
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         var_840 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,var_840);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (var_840 - 1) / 5 * _loc10_;
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - var_1020,(param2 - var_840) / 2));
         return _loc3_;
      }
