package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_1799:MarketplaceItemStats;
      ...
      private var var_176:MarketplaceConfirmationDialog;
      ...
      {
         if(!var_322 || !var_78 || !var_78.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = var_322.getValue(param1) as MarketPlaceOfferData;
         if(var_78.getPurse().credits < _loc2_.price)
         {
            var_78.showNotEnoughCreditsAlert("${catalog.alert.notenough.credits.description}");
            return;
         }
         showConfirmation(const_1476,_loc2_);
      }
      ...
      public function requestOffers(param1:int, param2:int, param3:String, param4:int) : void
      {
         ...
         if(var_78)
         {
            var_78.getPublicMarketPlaceOffers(param1,param2,param3,param4);
         }
      }
      
      public function requestOwnItems() : void
      {
         var_78.getOwnMarketPlaceOffers();
      }
      ...
      {
         if(param1.furniCategoryId != var_1798 || param1.furniTypeId != var_1804)
         {
            return;
         }
         var_1799 = param1;
      ...
      {
         var_78.getPublicMarketPlaceOffers(-1,-1,param1,-1);
      }
      ...
      private function getConfiguration() : void
      {
         ...
         var_78.connection.send(new GetMarketplaceConfigurationMessageComposer());
      }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            var_322.remove(parser.requestedOfferId);
            _visualization.listUpdatedNotify();
            if(_windowManager != null)
            {
         ...
         {
            updateItem = var_322.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               var_322.add(parser.offerId,updateItem);
            }
            var_322.remove(parser.requestedOfferId);
            showConfirmation(const_1577,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_632.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_632.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_353)
            {
               var_632.remove(_loc2_);
            }
         }
         var_78.redeemSoldMarketPlaceOffers();
         _visualization.listUpdatedNotify();
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1802 = _loc3_.creditsWaiting;
         var_632 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_632.add(_loc4_.offerId,_loc5_);
         }
      ...
      {
         var_78.getPublicMarketPlaceOffers(param1,-1,"",-1);
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_176)
         {
            var_176 = new MarketplaceConfirmationDialog(this,var_78,_roomEngine);
         }
         var_176.showConfirmation(param1,param2);
      }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_322.add(_loc4_.offerId,_loc6_);
         }
         if(_visualization == null)
         {
            return;
      ...
      {
         requestOffers(var_1800,var_1801,var_1805,var_1803);
      }
      ...
      {
         var_78.redeemExpiredMarketPlaceOffer(param1);
      }
      ...
      public function requestItemStats(param1:int, param2:int) : void
      {
         if(var_78)
         {
            var_1804 = param2;
            var_1798 = param1;
            var_78.getMarketplaceItemStats(param1,param2);
         }
      }
