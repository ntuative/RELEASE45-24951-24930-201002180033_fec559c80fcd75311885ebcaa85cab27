package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2078:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1472,this._model.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1471,this._model.mode != ThumbnailEditorModel.const_16);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1472 = IButtonWindow(find("top_tab"));
         var_1471 = IButtonWindow(find("obj_tab"));
         var_2079 = IWindowContainer(find("tile_grid"));
         var_2078 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1472,onTopTabButton);
         Util.setProcDirectly(var_1471,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2079;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_401)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2078;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_38,HabboWindowStyle.const_20,HabboWindowParam.const_50,new Rectangle(0,0,param1.width,66)));
