package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1089:int = -16;
      
      private static const const_749:int = 32;
      
      private static const const_1090:int = 8;
      
      public static const const_401:int = 10;
      ...
      private var var_841:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_841 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_841.getImage(ThumbnailEditorModel.const_16,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1089,_loc4_.y + const_1088 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2135[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_841.getImage(ThumbnailEditorModel.const_18,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_841.getImage(ThumbnailEditorModel.const_18,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_841.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_749 + _loc3_,param2 * const_1090);
      }
