package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_723:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1080 = new Timer(100);
         var_1080.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_54 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_43 = IItemListWindow(var_17.findChildByName("item_list"));
         ...
         var_910 = new TextFieldManager(_navigator,ITextFieldWindow(var_17.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_910.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         while(false)
         {
            _loc5_ = var_43.removeListItemAt(0);
            _loc5_.destroy();
         }
         ...
         if(!_navigator.data.hcMember)
         {
            ...
            var_43.addListItem(_loc7_);
         }
         var_1584 = _navigator.data.hcMember;
      }
      ...
      {
         var_910.goBackToInitialState();
         var_910.input.textBackgroundColor = 4294967295;
         var_723 = var_54[0];
         if(var_1584 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_38,HabboWindowStyle.const_20,HabboWindowParam.const_50,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_910.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_723.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1081 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1081 = true;
            _loc3_.y = 1;
