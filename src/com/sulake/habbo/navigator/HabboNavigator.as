package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_305:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1975:ISessionDataManager;
      
      private var var_1976:RoomCreateViewCtrl;
      
      private var var_1806:RoomThumbnailRenderer;
      
      private var var_179:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1190:RoomInfoViewCtrl;
      
      private var var_78:IHabboCatalog;
      
      private var var_381:Tabs;
      
      private var var_468:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_468 = new MainViewCtrl(this);
         var_1190 = new RoomInfoViewCtrl(this);
         var_1976 = new RoomCreateViewCtrl(this);
         var_1806 = new RoomThumbnailRenderer(this);
         var_1004 = new GuestRoomPasswordInput(this);
         var_305 = new GuestRoomDoorbell(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_468.startSearch(Tabs.const_198,Tabs.const_268,param1);
         var_468.mainWindow.activate();
      }
      ...
      {
         var_78 = IHabboCatalog(param2) as IHabboCatalog;
      }
      ...
      {
         if(param1 != null && var_179 != null)
         {
            var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_179 != null)
         {
            var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1975 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_468.startSearch(Tabs.const_238,Tabs.const_200);
         var_381.getTab(Tabs.const_238).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_468.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
