package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1806 = new RoomThumbnailRenderer(param1);
         var_957 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_154,var_105.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_154.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_154.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_957.refreshTags(_loc1_,var_105.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1806.refreshThumbnail(_loc1_,var_105.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_154 == null)
         {
            var_154 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_154.visible = true;
         Util.hideChildren(var_154);
         refreshRoomName(var_154,var_105);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_154,!true ? getEventCtg(var_105.categoryId) : getRoomCtg(var_105.categoryId));
         refreshRoomDesc(var_154,var_105);
         refreshExtraCont();
         refreshInfo(var_154,"trading_allowed",var_105.allowTrading);
         refreshInfo(var_154,"doormode_doorbell",false);
         refreshInfo(var_154,"doormode_password",false);
         Util.moveChildrenToColumn(var_154,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_154.height = Util.getLowestPoint(var_154);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_173,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
