package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_745:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         addTag(_loc6_,var_744.getText());
         addTag(_loc6_,var_746.getText());
      ...
      {
         var_745.visible = false;
         var_1394.visible = true;
         var_1796.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_631.setText(param1.eventDescription);
         var_744.setText(getTagFromEvent(param1,1));
         var_746.setText(getTagFromEvent(param1,2));
         var_1156.visible = false;
         var_1155.visible = true;
         var_1157.visible = true;
         var_1392.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1394 = IWindowContainer(find("event_type_disabled_cont"));
            var_1796 = ITextWindow(find("event_type_disabled_text"));
            var_1392 = ITextWindow(find("create_caption"));
            var_1393 = ITextWindow(find("edit_caption"));
            var_1156 = IButtonWindow(find("create_button"));
            var_1155 = IButtonWindow(find("edit_button"));
            var_1795 = IButtonWindow(find("cancel_button"));
            var_1157 = IButtonWindow(find("end_button"));
            var_745 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1156,onCreateButtonClick);
            Util.setProcDirectly(var_1155,onEditButtonClick);
            Util.setProcDirectly(var_1157,onEndButtonClick);
            Util.setProcDirectly(var_1795,onCancelButtonClick);
            ...
            var_744 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_746 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function createEvent() : void
      {
         ...
         var_746.goBackToInitialState();
         var_745.selection = 0;
         var_1392.visible = true;
