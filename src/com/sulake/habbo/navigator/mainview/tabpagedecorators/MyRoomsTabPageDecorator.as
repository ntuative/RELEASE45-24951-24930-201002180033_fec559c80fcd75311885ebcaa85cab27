package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_422:IDropMenuWindow;
      ...
      {
         var _loc1_:int = var_422 == null ? 0 : int(var_422.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_422 == null)
         {
            var_422 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_422.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
