package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_150:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_2043:IAvatarRenderManager;
      
      private var var_1461:AvatarSearchResults;
      
      private var var_130:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_802:FriendRequests;
      
      private var var_2042:int;
      
      var var_335:FriendCategories;
      
      private var var_179:IHabboToolbar;
      
      private var var_2045:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_381:FriendListTabs;
      
      private var var_2044:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1460:OpenedToWebPopup;
      ...
      {
         var_2045 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_335 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1461 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1460 == null)
         {
            var_1460 = new OpenedToWebPopup(this);
         }
         var_1460.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_802.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_802.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_381.findTab(FriendListTab.const_84).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_802.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_179.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_335.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_802 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_335.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_335.addCategory(new FriendCategory(FriendCategory.const_826,getText("friendlist.friends")));
         var_335.addCategory(new FriendCategory(FriendCategory.const_374,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_335.addFriend(new Friend(_loc4_));
         }
         ...
         getBuddyRequests();
         registerListeners();
         var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_335.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_2043.createAvatarImage(param1,AvatarScaleType.const_81);
         return _loc2_.getCroppedImage(AvatarSetType.const_30);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2043 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_802.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_381.findTab(FriendListTab.const_84);
      ...
      {
         var_2044 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_335.getFriendCount(param1,param2);
      }
      ...
      {
         var_179 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1461.searchReceived(_loc2_.friends,_loc2_.others);
