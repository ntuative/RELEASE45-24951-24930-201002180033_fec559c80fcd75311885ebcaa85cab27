package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1226 != "")
         {
            friendList.refreshText(param1,"name_text_online",var_681,var_1226);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",var_681,var_1490);
         }
         friendList.refreshText(param1,"name_text_offline",!var_681,var_1490);
         friendList.refreshText(param1,"motto_text",var_681,var_2116);
         friendList.refreshButton(param1,"offline",!var_681,null,0);
         if(var_681)
         {
            refreshFigure(param1,var_2115);
