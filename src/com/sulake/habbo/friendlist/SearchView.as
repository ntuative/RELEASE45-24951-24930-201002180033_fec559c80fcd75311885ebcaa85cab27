package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         var_652.addEventListener(WindowKeyboardEvent.const_117,onSearchStrInput);
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_334.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_334.showPopup(_friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_43.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_270,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = var_43.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(var_43.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
