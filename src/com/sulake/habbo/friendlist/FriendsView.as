package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1918:IContainerButtonWindow;
      
      private var var_1917:IContainerButtonWindow;
      
      private var var_1916:IContainerButtonWindow;
      
      private var var_1919:IContainerButtonWindow;
      
      private var var_334:AvatarPopupCtrl;
      ...
      {
         _friendList = param1;
         var_334 = new AvatarPopupCtrl(_friendList);
      }
      ...
      {
         var_1917 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1916 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1918 = initButton("room_invite",onInviteButtonClick,param1);
         var_1919 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:Array = _friendList.categories.method_1();
         if(_loc3_.length == 0)
         {
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_334.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.method_3);
            this.var_334.showPopup(_friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_11)
         {
            this.var_334.closePopup();
         }
      ...
      {
         var _loc1_:Array = _friendList.categories.method_1();
         setEnabled(var_1917,isEnableMinimailButton(_loc1_));
         setEnabled(var_1916,isEnableHomeButton(_loc1_));
         setEnabled(var_1918,isEnableInviteButton(_loc1_));
         setEnabled(var_1919,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = var_43.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
