package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(var_42 == null)
         {
            var_42 = IWindowContainer(_friendList.getXmlWindow(var_1199));
            var_42.visible = false;
            param1.addChild(var_42);
         }
         refreshContent(var_42);
         var_42.width = Util.getRightmostPoint(var_42) + 10;
         var_42.height = Util.getLowestPoint(var_42) + 10;
         var _loc3_:Point = new Point();
         var _loc4_:Point = new Point();
         param1.getGlobalPosition(_loc3_);
         param2.getGlobalPosition(_loc4_);
         var_42.x = _loc4_.x - _loc3_.x + var_1820 + param2.width;
         var_42.y = _loc4_.y - _loc3_.y - 0 + param2.height * 0.5;
         var _loc5_:Point = new Point();
         var_42.getGlobalPosition(_loc5_);
         if(_loc5_.x + var_42.width > var_42.desktop.width)
         {
            var_42.x = 0 + _loc4_.x - _loc3_.x + var_1821;
