package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_666,RoomWidgetStickieSendUpdateMessage.const_486,RoomWidgetStickieSendUpdateMessage.const_358];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_666:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_928);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
            ...
            case RoomWidgetStickieSendUpdateMessage.const_358:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_486:
