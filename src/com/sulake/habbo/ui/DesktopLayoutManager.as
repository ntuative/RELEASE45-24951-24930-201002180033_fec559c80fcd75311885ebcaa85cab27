package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1624:String = "room_desktop_layout_container";
      
      private const const_1104:String = "room_view";
      
      private var var_708:int = 50;
      
      private var var_2307:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_56.getChildByTag(const_1104) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_56.findChildByTag(const_1104) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_708;
               _loc2_.width = var_56.desktop.width - var_708;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_708;
               _loc2_.height = var_56.desktop.height - var_708;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_56.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_56.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_307,trimContainer);
            }
            _loc5_++;
         }
      }
