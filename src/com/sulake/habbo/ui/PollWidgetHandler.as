package com.sulake.habbo.ui
{
   ...
   public class PollWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetPollMessage.ANSWER,RoomWidgetPollMessage.const_410,RoomWidgetPollMessage.const_521];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionPollEvent.const_106:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_106);
               _loc3_.summary = _loc2_.summary;
               break;
            case RoomSessionPollEvent.const_46:
               _loc3_ = new RoomWidgetPollUpdateEvent(_loc2_.id,RoomWidgetPollUpdateEvent.const_46);
               _loc3_.summary = _loc2_.summary;
               break;
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPollMessage.const_521:
               _container.roomSession.sendPollStartMessage(_loc2_.id);
               break;
            case RoomWidgetPollMessage.const_410:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionPollEvent.const_106);
         _loc1_.push(RoomSessionPollEvent.const_46);
