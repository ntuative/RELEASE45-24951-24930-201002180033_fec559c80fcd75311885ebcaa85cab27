package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_1171:Boolean = true;
      ...
      private var var_1838:IHabboHelp = null;
      ...
      private var var_1072:IAvatarRenderManager = null;
      ...
      private var var_155:IToolTipWindow;
      
      private var var_544:ISessionDataManager = null;
      
      private var var_1837:uint = 16777215;
      
      private var var_78:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         var_51 = new Map();
         var_210 = new Map();
         var_209 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_276,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_344,onRoomContentLoaded);
      ...
      {
         var_179 = param1;
         var_179.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
      ...
      public function init() : void
      {
         ...
         {
            var_637 = _roomEngine.loadRoomResources(var_32.roomResources);
            if(false)
            {
               var_1171 = false;
         ...
         if(var_482 != null && true)
         {
            var_1172 = !var_482.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_32.roomId,var_32.roomCategory,var_240[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_276,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_344,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1837);
      ...
      {
         var_209.setLayout(param1,_windowManager);
         if(var_179 != null)
         {
            var_209.toolbarSize = var_179.size;
            var_209.toolbarOrientation = var_179.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_155 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_155.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         var_209.addWidgetWindow(_loc2_.mainWindow);
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_209.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_209 != null)
         {
            var_209.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_645:
               ...
               if(var_1401 != null && _loc3_ == RoomObjectCategoryEnum.const_19)
               {
                  _loc7_ = var_32.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_386)
                  {
                     var_1401.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_213:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_382:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_184,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_PRESENT:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_481,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_209.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_653);
            _loc13_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_600);
            _loc14_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_598);
            _loc15_ = _roomEngine.getRoomNumberValue(var_32.roomId,var_32.roomCategory,RoomVariableEnum.const_567);
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_32 != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_179.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_369:
               ...
               var_155 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_287,WindowParam.const_67) as IToolTipWindow;
               var_155.setParamFlag(WindowParam.const_31,false);
      ...
      {
         if(var_18 != null && var_32 != null && var_1172 && var_1171)
         {
            var_18.startSession(var_32);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_220));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_209.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
