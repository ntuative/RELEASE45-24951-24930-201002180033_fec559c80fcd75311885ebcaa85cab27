package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_816:IHabboSoundManager;
      
      private var var_1836:IHabboAvatarEditor = null;
      
      private var var_482:IAdManager;
      ...
      private var var_1072:IAvatarRenderManager;
      ...
      private var var_544:ISessionDataManager;
      ...
      private var var_1838:IHabboHelp;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1001 = RoomDesktop.const_404;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.sessionDataManager = var_544;
         _loc3_.roomSessionManager = var_18;
         _loc3_.friendList = _friendList;
         _loc3_.avatarRenderManager = var_1072;
         _loc3_.inventory = var_8;
         _loc3_.toolbar = var_179;
         _loc3_.navigator = _navigator;
         _loc3_.avatarEditor = var_1836;
         _loc3_.catalog = var_78;
         _loc3_.adManager = var_482;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_1838;
         _loc3_.moderation = var_1401;
         _loc3_.config = _config;
         _loc3_.soundManager = var_816;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_816 = param2 as IHabboSoundManager;
      }
      ...
      private function onCatalogReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_78 = param2 as IHabboCatalog;
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionEvent.const_272:
            ...
            case RoomSessionEvent.const_78:
               if(param1.session != null)
               {
                  ...
                  var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.ZOOM));
                  var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.MEMENU));
                  var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            var_482.events.addEventListener(AdEvent.const_335,adEventHandler);
            var_482.events.addEventListener(AdEvent.const_337,adEventHandler);
            var_482.events.addEventListener(AdEvent.const_419,adEventHandler);
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_179 != null)
         {
            var_179.release(new IIDHabboToolbar());
            var_179 = null;
         }
         if(_config != null)
         {
         ...
         if(var_816 != null)
         {
            var_816.release(new IIDHabboSoundManager());
            var_816 = null;
         }
         if(var_246)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_404)
            {
               var_1001 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_544 = param2 as ISessionDataManager;
      }
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_602:
               ...
               if(_roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
                     var_179.events.dispatchEvent(_loc7_);
                  }
                  else
                  {
                     _loc5_ = true;
               ...
               if(var_1001 != RoomDesktop.const_404)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_250,var_1001);
               }
               if(var_482 != null)
               {
                  var_482.showRoomAd();
            ...
            case RoomEngineEvent.const_693:
               ...
               break;
            case RoomEngineRoomColorEvent.const_548:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_199:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_483:
            ...
            case RoomSessionErrorMessageEvent.const_192:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_504:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_548,roomEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_490,roomObjectEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_172,roomObjectEventHandler);
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1072 = param2 as IAvatarRenderManager;
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_179 = param2 as IHabboToolbar;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(var_18)
         {
            var_18.events.addEventListener(RoomSessionEvent.const_272,roomSessionStateEventHandler);
            var_18.events.addEventListener(RoomSessionEvent.const_75,roomSessionStateEventHandler);
            var_18.events.addEventListener(RoomSessionEvent.const_78,roomSessionStateEventHandler);
            var_18.events.addEventListener(RoomSessionChatEvent.const_136,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_107,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionPresentEvent.const_232,roomSessionEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_483,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_828,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_937,roomSessionDialogEventHandler);
            ...
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_504,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_584,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_146,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_535,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_699,roomSessionDialogEventHandler);
            var_18.events.addEventListener(RoomSessionQueueEvent.const_414,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_109,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionVoteEvent.const_102,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_108,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_46,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionPollEvent.const_106,roomSessionEventHandler);
            var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_367,roomSessionEventHandler);
         }
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1836 = param2 as IHabboAvatarEditor;
      }
   }
}
