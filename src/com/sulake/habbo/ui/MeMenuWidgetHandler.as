   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_179 + " " + _loc6_);
            if(var_179 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_984,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_179.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_715,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_359,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_82,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_715,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_967,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_561,onHabboClubSubscriptionChanged);
         }
         var_179 = _container.toolbar;
         if(var_179)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_359,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_82,onHelpTutorialEvent);
         }
         var_78 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_82:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_82));
               break;
            case HabboHelpTutorialEvent.const_359:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_385));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_606);
         _loc1_.push(RoomWidgetDanceMessage.const_585);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_589);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_635);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_614);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_480);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_582);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_624);
         _loc1_.push(RoomWidgetStopEffectMessage.const_677);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1140);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_778);
         _loc1_.push(RoomWidgetToolbarMessage.const_524);
         _loc1_.push(RoomWidgetToolbarMessage.const_520);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_494);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1171);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_910);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_664);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_617);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_661);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_697);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1144);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_545);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_713);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_488);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_507));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_617:
               ...
               {
                  _loc8_ = new HabboToolbarEvent(HabboToolbarEvent.const_45);
                  _loc8_.iconId = HabboToolbarIconEnum.MEMENU;
                  _container.toolbar.events.dispatchEvent(_loc8_);
               }
               break;
            case RoomWidgetWaveMessage.const_606:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_585:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_589:
               if(var_8 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_635:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_614:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_624:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_78 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.CATALOG_CLUB)
               {
                  var_78.openCatalogPage(CatalogPageName.const_297,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_582:
               ...
               if(var_8 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_855:
                        var_78.openCatalogPage(CatalogPageName.const_1245,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_894:
                        var_8.toggleInventoryPage(InventoryCategory.const_222);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1294:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_480:
            case RoomWidgetStopEffectMessage.const_677:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_785:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_778:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_664:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_524:
               ...
               if(var_179)
               {
                  var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_78 != null && var_78.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_78.getPurse().credits));
                  }
               }
            ...
            case RoomWidgetToolbarMessage.const_520:
               ...
               if(var_179 && false)
               {
                  var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_345,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_494:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_356,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_995));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_356,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1356));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_654));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_661:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_697:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_269,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_713:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_269,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_488:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_568));
               }
               break;
            default:
