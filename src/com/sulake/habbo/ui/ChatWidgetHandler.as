package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomSessionChatEvent.const_136];
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_436.length)
            {
               _loc2_ = var_436.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_136:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_436.getValue(_loc15_) as BitmapData;
                           ...
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_277:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_81);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_81);
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_30).clone();
      ...
      {
         return [RoomWidgetChatMessage.const_671,RoomWidgetChatSelectAvatarMessage.const_557];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_671:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_136,_container.roomSession,0,"Version 24951-24930-201002172355");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_737 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_737);
            }
            if(var_437 == null)
            {
               var_435.x = 0;
               var_435.y = 0;
               var_435.z = 0;
               var_437 = _loc4_.getScreenPoint(var_435);
               var_737 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_435.x = 0;
            var_435.y = 0;
            var_435.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_435);
            if(_loc8_ != null)
            {
