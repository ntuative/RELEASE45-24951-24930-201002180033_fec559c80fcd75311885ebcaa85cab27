package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1666:BitmapData = null;
      ...
      private var var_1668:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_419,0,0,_loc4_,var_1364,var_1668,var_1666));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1667 = int(_config.getKey("interstitial.interval","30000"));
         var_1669 = int(_config.getKey("interstitial.show.time","5000"));
         var_1366 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1113 = _loc2_.imageUrl;
         var_1364 = _loc2_.clickUrl;
         if(var_1113 != "" && var_1364 != "")
         {
            _loc3_ = var_1113;
            ...
            _loc4_ = new URLRequest(var_1113);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1112 = _loc2_.imageUrl;
         var_1665 = _loc2_.clickUrl;
         var_618 = getTimer();
         if(var_1112 != "")
         {
            _loc3_ = var_1112;
            ...
            if(var_203 == null)
            {
               var_203 = new Timer(var_1669,1);
               var_203.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_203.reset();
            ...
            var_203.start();
            _loc4_ = new URLRequest(var_1112);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      {
         if(var_203 != null && true)
         {
            return;
         }
         if(isValidAdImage(param1))
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_337,0,0,param1.bitmapData,var_1665));
            var_618 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1666 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      
      public function showInterstitial() : Boolean
      {
         if(var_203 != null && false)
         {
            var_203.reset();
            return false;
         }
         ...
         if(var_1366 > 0 && var_1365 >= var_1366)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_618;
         if(_loc1_ > var_1667)
         {
            ++var_1365;
      ...
      {
         var_511 = param2 as IHabboCommunicationManager;
         if(var_511 == null)
         {
            return;
         }
         _connection = var_511.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_335));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1668 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
