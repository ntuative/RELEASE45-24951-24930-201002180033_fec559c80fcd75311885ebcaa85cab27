package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_189 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_38,HabboWindowStyle.const_846,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1019 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_1019)
         {
         ...
         var_1501 = _loc7_.toolbar.@min_group_margin;
         var_1502 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_257,param1,param2,_window,var_262);
         createGroupsFromXmlList(_loc9_,var_567,param1,param2,var_189,var_262);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_126,var_491,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1501,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1266) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1501,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1266) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_567.length)
         {
            _loc3_ = var_567[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_126,var_491);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_567.length)
         {
            _loc2_ = var_567[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_491);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_126,var_491);
         }
      }
