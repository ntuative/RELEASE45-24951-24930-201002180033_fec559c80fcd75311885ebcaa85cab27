package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_511.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_103,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_984,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_28,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_345,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_709,onDisplayWindowEvent);
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_31 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_28)
            {
