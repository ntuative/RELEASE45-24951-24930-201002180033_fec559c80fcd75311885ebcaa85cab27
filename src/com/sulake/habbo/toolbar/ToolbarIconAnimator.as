package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         if(var_1259 == true || var_682 == 0)
         {
            if(false)
            {
               ++var_46;
               if(var_46 >= var_835.length)
               {
                  var_46 = 0;
                  ++var_682;
               }
      ...
      {
         return var_1259 == false && var_682 == 1 && var_1120 != var_31;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_46 <= var_834.length)
         {
            _loc2_ = var_834[var_46];
