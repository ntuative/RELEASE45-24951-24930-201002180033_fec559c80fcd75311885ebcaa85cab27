package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1083:Number = 90;
      
      private static const const_736:int = 50;
      
      private static const const_1042:Number = 25;
      
      private static const const_1043:int = 50;
      
      private static const const_166:Boolean = true;
       
      
      private var var_535:Timer;
      
      private var var_962:ToolbarView;
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_962.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_278.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_278.splice(var_278.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_962.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_278[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_736 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_736 || param1.desktop.height - param1.y < const_1043;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_462[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
