package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1399:UserTagManager;
      ...
      private var var_1398:GroupDetailsView;
      
      private var _name:String;
      
      private var var_457:int = 0;
      
      private var var_953:FurnitureDataParser;
      ...
      private var var_752:IgnoredUsersManager;
      
      private var var_730:Dictionary;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_951:HabboGroupInfoManager;
      
      private var _gender:String;
      
      private var var_1822:Boolean;
      
      private var var_952:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_636 = [];
         var_1399 = new UserTagManager(events);
         var_951 = new HabboGroupInfoManager(this,events);
         var_752 = new IgnoredUsersManager(this);
      ...
      {
         var_952.removeEventListener(ProductDataParser.const_131,onProductsReady);
         var_952 = null;
         _floorItems = new Map();
         _wallItems = new Map();
         var_753 = new Map();
         ...
         var_953 = new FurnitureDataParser(_loc2_,_floorItems,_wallItems,var_753,_localization);
         var_953.addEventListener(FurnitureDataParser.const_131,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1399.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_167.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_952 = new ProductDataParser(_loc2_,var_730);
         var_952.addEventListener(ProductDataParser.const_131,onProductsReady);
      }
      
      public function getProductData(param1:String) : IProductData
      {
         return var_730[param1];
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return var_951.getBadgeId(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         var_752.unignoreUser(param1);
      }
      ...
      {
         return var_1169.getBadgeImage(param1,BadgeImageManager.const_905);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         var_457 = _loc3_.petRespectLeft;
         var_560 = _loc3_.figure;
         _gender = _loc3_.sex;
         var_1226 = _loc3_.realName;
         var_752.initIgnoreList();
      }
      ...
      {
         return var_951.getGroupDetails(param1);
      }
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_753.getValue(param1)));
      }
      ...
      {
         return var_752.isIgnored(param1);
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1823 = _loc2_.isOpen;
         var_1822 = _loc2_.onShutDown;
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return var_1169.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1398 == null)
         {
            var_1398 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_951.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1398.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_953.removeEventListener(FurnitureDataParser.const_131,onFurnitureReady);
         var_953 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_457 < 1 || _loc2_ == null)
         {
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_636.indexOf(param1) >= 0;
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_753.getValue(param1)));
      }
      
      public function ignoreUser(param1:String) : void
      {
         var_752.ignoreUser(param1);
      }
      
      private function onUserRights(param1:IMessageEvent) : void
      {
         var _loc2_:UserRightsMessageEvent = param1 as UserRightsMessageEvent;
         var_636 = _loc2_.rights;
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1399.communication = _communication;
         var_951.communication = _communication;
         var_752.registerMessageEvents();
      }
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_636.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1169 = new BadgeImageManager(_loc1_,events,var_167,_localization);
      }
