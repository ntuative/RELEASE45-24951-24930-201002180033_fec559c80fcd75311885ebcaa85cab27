package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_941:UserDataManager;
      ...
      {
         if(var_31 == RoomSessionEvent.const_272 && _connection != null)
         {
      ...
      {
         return var_941 as IUserDataManager;
      }
