package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         var_794 = true;
         if(var_181.getValue(_loc6_) != null)
         {
         ...
         var_181.add(_loc6_,_loc7_);
         _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_272,_loc7_));
         return true;
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1218)
         {
            gotoRoom(var_2022,var_2023,var_1217);
            var_1218 = false;
            var_1217 = "";
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_181)
         {
            while(false)
            {
               _loc1_ = var_181.getKey(0) as String;
               _loc2_ = var_181.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_181.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_181.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_181.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_181.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_181.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_78,_loc4_));
            _loc4_.dispose();
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_936:
                  break;
               case RoomSessionHandler.const_852:
                  break;
               case RoomSessionHandler.const_628:
