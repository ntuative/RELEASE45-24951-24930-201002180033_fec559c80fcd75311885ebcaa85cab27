package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1101:int = 20;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_130 = param1;
         var_1534 = initButton("follow_friend",onFollowButtonClick,param2);
         var_43 = IItemListWindow(param2.findChildByName("msg_list"));
         var_2183 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function findAddIndex() : int
      {
         ...
         {
            _loc2_ = var_43.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      {
         var _loc4_:ITextWindow = var_43.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_546 || param3.type == Message.const_500 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_496.messages.length - const_755);
         _loc1_ = 0;
      ...
      private function refreshListDims() : void
      {
         ...
         while(_loc1_ < var_43.numListItems)
         {
            _loc2_ = ITextWindow(var_43.getListItemAt(_loc1_));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_755 + const_1101)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_130.send(new FollowFriendMessageComposer(var_496.id));
      }
      ...
      {
         param1.width = var_43.width;
         param1.height = param1.textHeight + const_1100;
         param1.invalidate();
      }
   }
}
