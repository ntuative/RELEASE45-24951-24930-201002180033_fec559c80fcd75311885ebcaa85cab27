package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_619,0,var_393.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         return new Message(Message.const_493,0,getOnlineText(param1),Util.getFormattedNow());
      }
