package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         (_context as CoreComponent).error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,CoreComponent.const_1115);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1045[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_748 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_148));
         if(var_2225)
         {
      ...
      {
         var _loc4_:String = var_1045[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_2226);
