package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_1262:LagWarningLogger = null;
      ...
      private var var_168:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1262 = new LagWarningLogger();
         var_1263 = new Array(const_748);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1136,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1150,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1153,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_560,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_923,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1214);
               break;
            case HabboCommunicationEvent.const_669:
               trackLoginStep(HabboLoginTrackingStep.const_1111,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_204:
               trackLoginStep(HabboLoginTrackingStep.const_204);
               break;
            case HabboCommunicationEvent.const_138:
               trackLoginStep(HabboLoginTrackingStep.const_138);
               break;
      ...
      private function onCatalogReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_78.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_78.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_78.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_167)
         {
            Component(var_167).events.addEventListener(HabboConfigurationEvent.const_148,onConfigurationLoaded);
            if(var_223 != null)
            {
               var_223.configuration = var_167;
            }
            if(var_224 != null)
            {
               var_224.configuration = var_167;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_482.events.addEventListener(AdEvent.const_419,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_923,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_560,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_669,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_138,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_188,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_692,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_46,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_426:
               var_1262.registerWarning(LagWarningLogger.const_833);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_482)
            {
               var_482.release(new IIDHabboAdManager());
               var_482 = null;
            }
            if(_navigator)
            {
            ...
            if(var_78)
            {
               if(true)
               {
                  var_78.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_78.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_78.release(new IIDHabboCatalog());
               var_78 = null;
            }
            if(var_8)
            {
            ...
            if(var_168)
            {
               if(true)
               {
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_168).events.removeEventListener(HabboFriendListTrackingEvent.const_285,onFriendlistTrackingEvent);
               }
               var_168.release(new IIDHabboFriendList());
               var_168 = null;
            }
            if(var_396)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_148);
         if(var_167)
         {
            Component(var_167).events.removeEventListener(HabboConfigurationEvent.const_148,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_73);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_73,onLocalizationLoaded);
         }
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_882);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_882,onCoreRunning);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1497;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1497);
         }
         if(var_1017 > -1 && _loc2_ - var_1017 > 15000)
         {
            ++var_1496;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1496);
         }
         var_1017 = _loc2_;
         if(var_224 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_247,onRoomAdClick);
      }
      ...
      {
         var_168 = param2 as IHabboFriendList;
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_168).events.addEventListener(HabboFriendListTrackingEvent.const_285,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_2124)
         {
            var_2124 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1253,new Date().getTime().toString());
            if(var_167)
            {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_73,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_692)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1165);
         }
         else if(param1.type == HabboHotelViewEvent.const_392)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1279);
         }
         else if(param1.type == HabboHotelViewEvent.const_46)
         {
