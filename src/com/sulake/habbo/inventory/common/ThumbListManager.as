package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_992:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_85 = var_553.height;
         var_993 = param5;
         var_808 = param6;
         var_217 = Math.floor(var_993 / _thumbWidth);
         var_16 = new BitmapData(var_993,var_808);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_481 - 1)
         {
            ...
            var_16.fillRect(new Rectangle(0,0 - var_85,var_16.width,var_85),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_16.width,0 - var_85);
               _loc2_ = new Rectangle(0,0,var_16.width,0 - var_85);
               _loc11_.copyPixels(var_16,_loc2_,new Point(0,0),null,null,true);
               var_16 = _loc11_;
               --var_481;
            }
         }
         if(var_16.height < var_808)
         {
            _loc12_ = new BitmapData(var_16.width,var_808);
      ...
      private function getList() : Array
      {
         ...
         if(var_992 != null)
         {
            _loc1_ = var_992.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_16 = new BitmapData(Math.max(var_217 * _thumbWidth,var_993),Math.max(var_481 * var_85,var_808),true,16777215);
            ...
            while(_loc4_ < var_217)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_16.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_85),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_217 && var_16.height < _loc3_.y * var_85)
         {
            _loc2_ = new BitmapData(var_16.width,var_16.height + var_85);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_217 - 1),var_85);
         _loc2_.copyPixels(var_16,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_217 - 1),0,_thumbWidth,var_16.height);
         _loc2_.copyPixels(var_16,_loc4_,new Point(0,var_85),null,null,true);
         _loc4_ = new Rectangle(0,var_85,_thumbWidth * (var_217 - 1),0 - var_85);
         _loc2_.copyPixels(var_16,_loc4_,new Point(_thumbWidth,var_85),null,null,true);
         var_16 = _loc2_;
      }
