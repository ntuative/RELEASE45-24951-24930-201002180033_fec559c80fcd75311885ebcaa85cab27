package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1608:int = 13421772;
      ...
      protected var var_2248:BitmapData;
      ...
      private const const_1400:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_680)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1485));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1322);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1400;
               _loc1_.blend = const_1400;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1334 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2248;
               _loc5_.visible = true;
            }
            else
            {
