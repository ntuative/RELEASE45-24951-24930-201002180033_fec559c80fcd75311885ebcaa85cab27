package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_271:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_172,onObjectPlaced);
         var_421 = new Timer(const_1015,1);
         var_421.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_223;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_355.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_355.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_680)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_172,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_421 != null)
            {
               var_421.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_421.stop();
               var_421 = null;
            }
            if(var_112 != null)
            {
               var_112.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_112.stop();
               var_112 = null;
            }
            if(var_606 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_289)
         {
         ...
         else if(param3 == FurniCategory.const_279)
         {
         ...
         if(var_606 == null)
         {
            var_606 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_606.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_223:
               ...
               break;
            case InventorySubCategory.const_935:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_112 = new Timer(param1,1);
            var_112.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_112.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_340);
         ...
         if(param1 == InventoryCategory.const_54 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_25:
                  ...
                  break;
               case const_271:
                  _controller.toggleInventoryPage(InventoryCategory.const_139);
            }
         }
      }
      ...
      {
         if(var_722 && param1.type == RoomEngineObjectEvent.const_172)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_279 || _loc3_.category == FurniCategory.const_289 || _loc3_.category == FurniCategory.const_301)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_355 = new Map();
         var_355.add(const_24,new Array());
         var_355.add(const_25,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
