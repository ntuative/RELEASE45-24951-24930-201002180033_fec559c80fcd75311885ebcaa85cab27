package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1147 && param1.type == RoomEngineObjectEvent.const_172)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1147 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_19,RoomObjectTypeEnum.const_277,_loc3_.figure);
      ...
      {
         if(var_946.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
