package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      public function PetsGridItem(param1:PetsView, param2:PetData, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IAvatarRenderManager)
      {
         ...
         var _loc8_:BitmapData = _loc7_.getCroppedImage(AvatarSetType.const_30);
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_33:
               var_959.setSelectedGridItem(this);
               var_766 = true;
               break;
            case WindowMouseEvent.const_79:
               var_766 = false;
               break;
            case WindowMouseEvent.const_11:
               ...
               {
                  var_766 = false;
                  var_959.placePetToRoom(var_1082.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1607) : uint(const_1608);
      }
