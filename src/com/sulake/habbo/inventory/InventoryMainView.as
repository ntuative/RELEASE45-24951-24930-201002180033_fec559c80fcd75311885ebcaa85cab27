package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_659 == InventoryCategory.const_139)
            {
               toggleCategoryView(InventoryCategory.const_139);
            }
            else if(var_659 == InventoryCategory.const_54)
            {
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_179 != null && var_788)
            {
               var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_179 != null)
         {
            var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_103,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_179 != null)
         {
            var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_709,HabboToolbarIconEnum.INVENTORY,var_11 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_179 != null && var_788)
         {
            var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_788 = false;
         }
         _controller.inventoryViewOpened(var_658);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_659 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_179 != null && var_788)
