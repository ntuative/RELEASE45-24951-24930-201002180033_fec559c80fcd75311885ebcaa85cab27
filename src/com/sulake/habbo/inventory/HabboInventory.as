package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_75,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_78,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_371,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_78:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_371:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_40.getValue(InventoryCategory.const_597));
      }
      ...
      {
         var_177.clubPeriods = param1;
         var_177.clubDays = param2;
         var_177.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_967));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_40.getValue(InventoryCategory.const_139));
      }
      ...
      {
         return AchievementsModel(var_40.getValue(InventoryCategory.const_291));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_223:
      ...
      {
         return TradingModel(var_40.getValue(InventorySubCategory.const_223));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_544 = ISessionDataManager(param2);
      ...
      {
         return var_177.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_40.getValue(InventoryCategory.const_340) as MarketplaceModel;
      }
      ...
      {
         return var_177.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_177.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_40.getValue(InventoryCategory.const_222));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_75,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_78,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_371,roomSessionEventHandler);
         ...
         var_40.add(InventoryCategory.const_340,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_544);
         var_40.add(InventoryCategory.const_222,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_40.add(InventoryCategory.const_597,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_544);
         var_40.add(InventoryCategory.const_291,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_40.add(InventorySubCategory.const_223,_loc8_);
         ...
         var_40.add(InventoryCategory.const_139,_loc10_);
