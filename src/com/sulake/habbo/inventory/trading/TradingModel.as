package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_357:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_215:uint = 3;
      
      public static const const_144:uint = 1;
      
      public static const const_159:uint = 0;
      
      public static const const_1350:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_493 = false;
         var_696 = false;
         var_39.updateItemList(var_697);
         var_39.updateItemList(var_1281);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_39.alertPopup(TradingView.const_853);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_696 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_39.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_39.alertPopup(TradingView.const_860);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_31 + " NEW STATE: " + param1 + " OWN: " + var_493 + " OTHER: " + var_696);
         ...
         {
            case const_159:
               if(param1 == const_144 || param1 == const_194)
               {
                  var_31 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_39.setMinimized(param1 != InventoryCategory.const_54);
         var_8.updateSubView();
      }
      ...
      public function close() : void
      {
         if(var_545)
         {
            if(var_31 != const_159 && var_31 != const_194)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_159;
            var_8.toggleInventorySubPage(InventorySubCategory.const_935);
            var_545 = false;
         }
         var_39.setMinimized(false);
      }
