package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_334:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_334 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_20.state)
                  {
                     case TradingModel.const_144:
                        if(var_20.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_823);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            var_334.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_331);
            var_334.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_55.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_55.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         return var_55.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      {
         var _loc2_:ITextWindow = var_55.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_55.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc2_:ITextWindow = var_55.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc1_:ITextWindow = var_55.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_55.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc1_:ITextWindow = var_55.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_55.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_55.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_20.otherUserName;
            }
            _loc1_ = var_55.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_750) : uint(const_751);
            }
            _loc3_ = var_55.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_55.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_750) : uint(const_751);
            }
            _loc3_ = var_55.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_55.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_55)
         {
            _loc1_ = var_55.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
