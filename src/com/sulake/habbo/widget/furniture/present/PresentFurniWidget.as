package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1012:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_42,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_336,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_42,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_42,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_336,onObjectUpdate);
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_42,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_42:
               hideInterface();
               var_207 = false;
               var_136 = param1.objectId;
               var_175 = param1.text;
               _controller = param1.controller;
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_336:
               if(!var_207)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_42:
               hideInterface();
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_207 || var_136 == -1 || !_controller)
         {
            return;
         }
         var_207 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_615,var_136);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1011,const_1012,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_175 != null)
         {
            _loc4_.caption = var_175;
         }
