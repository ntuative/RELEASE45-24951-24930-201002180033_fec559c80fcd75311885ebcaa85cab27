package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_42,onObjectUpdate);
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_42,onPresentUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_42,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_59,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_42,onPresentUpdate);
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_553,var_136);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1011,const_1012,2,2),null,0) as IWindowContainer;
         ...
         if(_loc6_ != null && var_175 != null)
         {
            _loc6_.caption = var_175;
         }
