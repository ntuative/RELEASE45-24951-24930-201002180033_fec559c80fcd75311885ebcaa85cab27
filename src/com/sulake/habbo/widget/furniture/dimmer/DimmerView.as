package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_306:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1011,const_1012,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            var_306 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_306 != null)
         {
            var_306.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_902 = _loc2_.light;
         if(var_306 != null)
         {
            var_306.setValue(var_902);
         }
         var_409 = colors.indexOf(_loc2_.color);
         if(var_419 != null)
         {
            var_419.setSelectedColorIndex(var_409);
         }
