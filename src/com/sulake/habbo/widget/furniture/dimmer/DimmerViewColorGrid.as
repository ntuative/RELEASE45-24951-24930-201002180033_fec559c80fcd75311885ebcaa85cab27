package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_423:BitmapData;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_356.destroyGridItems();
         var_285 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1088) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_423.width;
            _loc3_.height = var_423.height;
            var_356.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_423.width,var_423.height,true,0);
               _loc4_.bitmap.copyPixels(var_423,var_423.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_724.width,var_724.height,true,0);
      ...
      {
         var _loc2_:int = var_356.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_356.numGridItems)
         {
            return;
         }
         select(var_356.getGridItemAt(param1) as IWindowContainer);
      }
