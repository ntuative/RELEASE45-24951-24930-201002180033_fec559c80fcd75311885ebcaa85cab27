package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_140[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_140[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_140)
         {
            _loc6_ = var_140[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         var_140["rooms_icon"] = ["gohome_white","gohome_color"];
         var_140["dance_icon"] = ["dance_white","dance_color"];
         var_140["clothes_icon"] = ["clothes_white","clothes_color"];
         var_140["effects_icon"] = ["effects_white","effects_color"];
         var_140["badges_icon"] = ["badges_white","badges_color"];
         var_140["wave_icon"] = ["wave_white","wave_color"];
         var_140["hc_icon"] = ["_white","_color"];
         var_140["settings_icon"] = ["settings_white","settings_color"];
         var_140["credits_icon"] = ["credits_white","credits_color"];
         var_140["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_881);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_941));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_658);
               break;
            case "rooms":
            ...
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_484);
               break;
            case "news":
               if(false && false)
               {
