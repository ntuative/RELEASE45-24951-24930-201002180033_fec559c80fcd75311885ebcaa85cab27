   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_822 = _window.findChildByName("effect_hilite");
            var_822.visible = false;
         }
         var_823 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_821 = _window.findChildByName("loader_bar");
         if(var_821 != null)
         {
            var_390 = var_821.width;
            var_169.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_823 != null)
         {
            var_823.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_823.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
