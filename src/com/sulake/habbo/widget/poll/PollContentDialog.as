package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_621[var_932] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_273)
         {
            ...
            var_273 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_273.center();
            var_273.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_932;
         if(var_932 < var_621.length)
         {
            _loc1_ = var_621[var_932] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_621.length);
                  _loc2_.text = _loc6_;
               }
