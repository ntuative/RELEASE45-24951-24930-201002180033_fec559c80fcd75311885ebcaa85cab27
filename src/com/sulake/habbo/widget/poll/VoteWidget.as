package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_638:Array = null;
      ...
      private var var_929:Array = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_109,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_102,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_293,update);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(var_43.scrollableRegion.height - 0,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         var_43 = _window.findChildByName("choices") as IItemListWindow;
         if(var_43 == null)
         {
            return false;
         }
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_1626;
         if(_loc2_ > var_1101)
         {
            vote();
            return;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(var_43.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_43.numListItems)
         {
            _loc4_ = var_43.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_43.numListItems)
         {
            _loc2_ = var_43.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_109,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_102,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_293,update);
      }
