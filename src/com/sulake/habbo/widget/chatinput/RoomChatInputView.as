package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1395:int = 5;
      ...
      private static const const_1035:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1816 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1817 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_634 = new Timer(1000,1);
         var_634.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_38,HabboWindowStyle.const_23,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_117,windowKeyEventProcessor);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1818 = _loc2_.width + const_478 + _loc6_.width + const_1036;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1035,_loc8_.width) + const_478);
            _loc8_.x = _loc12_;
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_456);
