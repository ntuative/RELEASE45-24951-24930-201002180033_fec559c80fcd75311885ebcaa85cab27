package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      public function sendChat(param1:String, param2:int, param3:String = "") : void
      {
         ...
         checkForFlooding();
         var _loc4_:RoomWidgetChatMessage = new RoomWidgetChatMessage(RoomWidgetChatMessage.const_671,param1,param2,param3);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_184,onRoomObjectDeselected);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_253,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_652,onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_190,onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_583,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         {
            case RoomWidgetChatInputContentUpdateEvent.const_774:
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_184,onRoomObjectDeselected);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_253,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_652,onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_583,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_386 > const_1066)
         {
            if(_loc1_ < var_1240 + const_1067)
            {
               var_814 = true;
               var_673 = const_1068 / 1000;
               Logger.log("Enabling flood blocking");
               var_815 = new Timer(1000,var_673);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_541,_visualization.window);
         if(messageListener != null)
         {
