package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1109:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_1048,var_1046,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1048,var_1046,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1313 = param1.chatType;
         var_1048 = param1.userId;
         var_878 = param1.userName;
         var_1046 = param1.userCategory;
         _message = param1.text;
         var_1315 = param1.userX;
         var_194 = param1.userImage;
         var_1047 = param1.userColor;
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_79,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1313)
         {
            case RoomWidgetChatUpdateEvent.const_96:
               _loc1_ = "bubble_speak";
               break;
            case RoomWidgetChatUpdateEvent.const_86:
               _loc1_ = "bubble_whisper";
               break;
            case RoomWidgetChatUpdateEvent.const_85:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_217:
         ...
         var_91 = _window as IRegionWindow;
         var_91.background = true;
         var_91.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_91);
         ...
         if(var_194 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_411 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1047 != 0)
            {
               _loc30_ = uint(var_1047 >> 16 & 255);
               _loc31_ = uint(var_1047 >> 8 & 255);
               _loc32_ = uint(var_1047 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1313 == RoomWidgetChatUpdateEvent.const_217)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_878);
            }
            else if(var_1313 == RoomWidgetChatUpdateEvent.const_243)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_878);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_329 + _loc20_.textWidth + const_478;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1048,var_1046,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1048,var_1046,_roomId,_roomCategory,param1);
      }
