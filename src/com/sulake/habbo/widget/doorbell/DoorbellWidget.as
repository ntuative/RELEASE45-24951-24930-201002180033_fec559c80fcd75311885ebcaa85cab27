package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_547,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_112,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_113,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_547,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_112,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_113,onDoorbellHandled);
      }
