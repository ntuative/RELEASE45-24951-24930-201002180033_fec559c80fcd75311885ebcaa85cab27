package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1407:String = "infostand_user_view";
      
      private var var_292:InfoStandPetView;
      
      private var var_1082:InfoStandPetData;
      
      private var var_131:Timer;
      
      private var var_856:InfoStandFurniView;
      
      private var var_355:InfostandFurniData;
      
      private var var_336:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1408:String = "infostand_bot_view";
      ...
      private const const_1615:int = 3000;
      
      private var var_190:InfoStandUserView;
      
      private var var_384:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_856 = new InfoStandFurniView(this,const_1409);
         var_190 = new InfoStandUserView(this,const_1407);
         var_292 = new InfoStandPetView(this,const_1410);
         var_336 = new InfoStandBotView(this,const_1408);
         var_384 = new InfostandUserData();
         var_355 = new InfostandFurniData();
         var_1082 = new InfoStandPetData();
         var_131 = new Timer(const_1615);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_190.setTags(param1.tags,var_2157);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_184,onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_218,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_190,onUserInfo);
         ...
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_121,onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_107,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_485,onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_118,onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_450,var_292.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_184,onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_218,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_190,onUserInfo);
         ...
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_121,onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_107,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_485,onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_118,onPetInfo);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_111:
               _loc2_ = param1.id == var_355.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_218:
               if(var_190 != null && false && var_190.window.visible)
               {
                  _loc2_ = param1.id == var_384.userRoomId;
                  break;
               }
               if(var_292 != null && false && var_292.window.visible)
               {
                  _loc2_ = param1.id == var_1082.roomIndex;
                  break;
               }
