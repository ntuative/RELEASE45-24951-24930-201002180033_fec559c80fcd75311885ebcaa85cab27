package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_1705 = param1.petRace;
         _image = param1.image;
         var_1998 = param1.isOwnPet;
         var_1650 = param1.ownerId;
         _ownerName = param1.ownerName;
         _canOwnerBeKicked = param1.canOwnerBeKicked;
         var_1588 = param1.level;
         var_1647 = param1.levelMax;
         var_1649 = param1.experience;
         var_1644 = param1.experienceMax;
         _energy = param1.energy;
         var_1643 = param1.energyMax;
         _nutrition = param1.nutrition;
         var_1646 = param1.nutritionMax;
         _petRespect = param1.petRespect;
         var_1999 = param1.roomIndex;
         var_1645 = param1.age;
      }
