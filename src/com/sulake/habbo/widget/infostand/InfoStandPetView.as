package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1597:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1599:String = "level";
      ...
      private const const_1596:String = "nutrition";
      
      private var var_53:IItemListWindow;
      
      private const const_1595:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1594:int = 158;
      
      private const const_1601:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_231:PetCommandTool;
      
      private const const_1600:uint = 11184810;
      
      private const const_1598:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_212 != null)
         {
            var_96 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_96 == null || var_212 == null || var_53 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_231 == null)
         {
            var_231 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1082.getValue(var_705) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_231.showWindow(true);
            var_231.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1599,param1.level,param1.levelMax);
         updateStateElement(const_1598,param1.experience,param1.experienceMax);
         updateStateElement(const_1593,param1.energy,param1.energyMax);
         updateStateElement(const_1596,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_705 = param1.id;
         var_1082.remove(param1.id);
         var_1082.add(param1.id,param1);
         if(var_231 && var_231.isVisible() && param1.isOwnPet)
         {
            var_231.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_231.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_347,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1594,const_1601,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1600);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1595);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1597);
         return _loc5_;
      }
