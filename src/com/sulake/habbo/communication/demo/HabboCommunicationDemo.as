package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_161:HabboHotelView;
      ...
      private var var_1952:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1421:ILogger;
      
      private var var_1185:String;
      
      private var var_1954:String;
      
      private const const_1385:String = "fuselogin";
      
      private var var_511:ICoreCommunicationManager;
      
      private var var_465:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_969)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_138);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_266:
            ...
            case DisconnectReasonEvent.const_983:
               ...
               break;
            case DisconnectReasonEvent.const_781:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1953)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1185,var_1954));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1385,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_465.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_465.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1952);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1385,"/");
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1185 = _habboConfiguration.getKey("flash.client.url","");
         var_1954 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_161 == null)
         {
            var_161 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_646 != null)
         {
            var_63.mode = HabboConnectionType.const_387;
            var_63.initConnection(HabboConnectionType.const_227);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1421 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_669);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1952 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_63.mode)
         {
            case HabboConnectionType.const_387:
               _loc6_ = "";
               ...
               var_967 = _loc4_;
               var_161.loadBannerImage(_loc7_ + "?token=" + var_967,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1167:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1178:
               var_968 = generateRandomHexString(30);
               var_465 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_465.init(var_968);
               _loc8_ = var_465.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_161.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var_465 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_968 = generateRandomHexString(30);
            var_465.init(var_968);
            _loc12_ = var_465.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_148,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_78,onRoomSessionEnded);
      }
