package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      private var var_1139:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1139 = param2;
         var_1140 = "http://" + param3 + "/client";
         var_1139.init();
         var_1139.addEventListener(HabboWeb.const_207,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1140;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1140);
         }
         var _loc3_:URLRequest = new URLRequest(var_1140);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1139.requestReAuthenticate();
         }
         else
         {
            try
            {
               var_1387 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
