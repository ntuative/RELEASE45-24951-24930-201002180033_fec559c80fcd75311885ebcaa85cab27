package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_314:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_103:SSOTicket;
      ...
      {
         var_314.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_314.shockwaveClientUrl = var_103.shockwaveClientUrl;
         var_314.ssoTicket = var_103.ticket;
         var_103.removeEventListener(SSOTicket.const_278,onParsedTicketSuccess);
         var_103.removeEventListener(SSOTicket.const_257,onParsedTicketFailure);
         var_103 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1385,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_314 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_314.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_409,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_314.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_79,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1385,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_314.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_314.habboCommunication.habboWebLogin(name,password);
         var_103 = new SSOTicket(var_314.assets,_loc2_,_loc1_);
         var_103.addEventListener(SSOTicket.const_278,onParsedTicketSuccess);
         var_103.addEventListener(SSOTicket.const_257,onParsedTicketFailure);
      }
