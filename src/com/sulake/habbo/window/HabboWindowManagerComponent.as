package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_322:uint = 3;
      ...
      private var var_1145:IEventDispatcher;
      
      private var var_2341:uint = 0;
      
      private var var_1146:ProfilerAgentTask;
      
      private var var_1143:ProfilerOutput;
      
      private var var_627:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1145 = Component(param1).events;
            var_740 = new Array();
      ...
      {
         return var_275[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_275[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_627 = new WindowRenderer(_loc4_);
         var_275 = new Array(const_322);
         var _loc6_:int = 0;
         while(_loc6_ < const_322)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_627,this,_localization,var_195,new Rectangle(0,0,var_195.stageWidth,var_195.stageHeight),this);
            var_275[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_399 = var_275[const_1031];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_399.getMouseCursor().defineCustomCursorType(MouseCursorType.const_302,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_399.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1185,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_275[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_275.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_275[param1].getDesktopWindow().getChildAt(var_399.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1143 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1143 = new ProfilerOutput(_loc3_,this,var_627);
               var_1144 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1144);
               var_1146 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         return var_399.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1145.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_322 - 1;
            while(_loc2_ >= 0)
            {
               var_275[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_944)
         ...
         var_1145.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_322)
         {
            var_275[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_944)
         {
         ...
         if(WindowContext.var_1320.length > 0)
         {
            WindowContext.var_1320.flush();
         }
         var_1145.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_740[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_740[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_399.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1328,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1364,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1296,param2.name + ": " + param2.toString());
            }
         }
      }
   }
