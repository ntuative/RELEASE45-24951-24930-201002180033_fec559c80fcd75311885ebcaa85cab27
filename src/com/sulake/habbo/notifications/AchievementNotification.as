package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1588 = param2;
         var_544 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_100,onBadgeImageReady);
         ...
         var_175 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1704 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_175);
      ...
      public function dispose() : void
      {
         if(var_544 != null)
         {
            var_544.events.removeEventListener(BadgeImageReadyEvent.const_100,onBadgeImageReady);
            var_544 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_626,var_1704);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_626,var_626));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_626,var_626));
         _localizations.registerParameter(param1,"level",var_1588.toString());
         _localizations.registerParameter(param1,"name",var_544.userName);
         _localizations.registerParameter(param1,"realname",var_544.realName);
      }
   }
}
