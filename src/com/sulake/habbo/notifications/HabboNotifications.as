package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1005:String = "badges";
      
      private static const const_1004:String = "pixelbalance";
      
      private static const const_1008:String = "credits";
      
      private static const const_1009:String = "inventory";
      
      private static const const_1007:String = "friendlist";
      
      private static const const_1003:String = "selectfurni";
      
      private static const const_1006:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_507:ParkBusDialogManager;
      ...
      private var var_354:HabboNotificationViewManager;
      ...
      private var var_173:HabboAlertDialogManager;
      
      private var var_598:ClubGiftNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_718);
         }
         var _loc6_:Map = var_718["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_598 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,var_78);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_173 == null)
         {
            return;
         }
         var_173.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_971)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1221);
         }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_173.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_173.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc2_,NotificationType.const_1252);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1072.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_34);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_21,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_30).clone();
         _loc4_.dispose();
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_895,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_151 || param2.type == WindowEvent.const_659)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_354.isSpaceAvailable() && false)
         {
            var_354.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_507 == null)
         {
            var_507 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_507 != null)
         {
            var_507.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_899.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1072.createPetImage(_loc2_.figure,AvatarScaleType.const_34);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_544);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc15_.productType == CatalogPageMessageProductData.const_56)
               {
                  _loc16_ = var_544.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_60)
               {
                  _loc16_ = var_544.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_544.getProductData(_loc4_.localizationId);
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1072.createAvatarImage(param2,AvatarScaleType.const_34);
         if(_loc7_ != null)
         {
            _loc7_.setDirection(AvatarSetType.const_30,3);
            _loc4_ = _loc7_.getCroppedImage(AvatarSetType.const_30);
         }
         if(param3 == "")
         {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_173 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1074.events.addEventListener(HabboToolbarEvent.const_68,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_173.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_544.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_990);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_990);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_173.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_68)
         {
            ...
            var_354 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_718["styles"],var_718["view"],var_1074);
            ...
            registerUpdateReceiver(var_354,1);
            registerUpdateReceiver(this,2);
            var_544.events.addEventListener(BadgeImageReadyEvent.const_100,onBadgeImage);
