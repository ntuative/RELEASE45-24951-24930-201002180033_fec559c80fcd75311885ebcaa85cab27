package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_353:UserInfoCtrl;
      
      private var var_48:ModerationManager;
      
      private var var_898:UserInfoCtrl;
      
      private var var_101:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.releaseBundle(var_101.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_101.getHighestPriorityIssue();
         var_353 = new UserInfoCtrl(_window,var_48,_loc3_.message);
         var_898 = new UserInfoCtrl(_window,var_48,_loc3_.message);
         var_353.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_101.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_898.load(_loc4_,var_101.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_101.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_101.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_101.getHighestPriorityIssue().issueId;
         var_48.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_48,WindowTracker.const_820,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_48 != null && false && var_101 != null)
         {
            var_48.issueManager.removeHandler(var_101.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_101.getHighestPriorityIssue();
            var_353 = new UserInfoCtrl(_window,var_48,_loc3_.message);
            var_353.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_101.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_48.issueManager.closeBundle(var_101.id,3);
         checkAutoHandling();
         dispose();
      }
