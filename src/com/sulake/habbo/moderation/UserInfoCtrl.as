package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_742:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_742) + " mins ago";
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_44,WindowTracker.const_773,_data.userId),_callerFrame,var_973,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_778.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_44.getXmlWindow("user_info"));
            var_778.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new ModActionCtrl(var_44,_data.userId,_data.userName,var_1273),_callerFrame,var_973,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new RoomVisitsCtrl(var_44,_data.userId),_callerFrame,var_973,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new SendMsgsCtrl(var_44,_data.userId,_data.userName,var_1273),_callerFrame,var_973,false,true);
      }
