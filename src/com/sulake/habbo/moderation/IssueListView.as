package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_43 = param3;
         var_1103 = param4;
         var_1346 = var_556.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1346 == null)
            {
               return;
            }
            _loc2_ = var_1346.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = var_43.width;
