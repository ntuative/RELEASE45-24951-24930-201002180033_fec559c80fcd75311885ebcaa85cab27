package com.sulake.habbo.moderation
{
   ...
   public class OpenIssuesView implements IIssueBrowserView
   {
      ...
      private var var_1930:IssueListView;
      ...
      public function OpenIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_1930 = new IssueListView(param1,param2,_loc4_,"open_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_834);
         var_1930.update(_loc1_);
      }
   }
}
