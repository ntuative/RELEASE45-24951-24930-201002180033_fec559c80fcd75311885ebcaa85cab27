package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new UserInfoFrameCtrl(var_44,_userId),var_46,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new RoomToolCtrl(var_44,_roomId),var_46,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_44.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1096 ? 0 : 1,_roomId),var_44,WindowTracker.const_663,_roomId),var_46,false,false,true);
      }
      ...
      public function show() : void
      {
         if(var_46 == null)
         {
            var_46 = IFrameWindow(var_44.getXmlWindow("start_panel"));
            ...
            var_44.disableButton(var_44.initMsg.cfhPermission,var_46,"ticket_queue_but");
