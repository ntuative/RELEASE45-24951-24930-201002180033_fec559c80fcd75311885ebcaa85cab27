package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1545:IIssueBrowserView;
      
      private const const_1620:String = "open_issues";
      ...
      private const const_1625:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1622:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_228:ITabContextWindow;
      
      private var var_1546:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_343.view.width = var_228.container.width;
         var_343.view.height = var_228.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1622:
               if(var_1547 == null)
               {
                  var_1547 = new MyIssuesView(issueManager,this,var_228.container);
               }
               return var_1547;
            case const_1620:
               if(var_1545 == null)
               {
                  var_1545 = new OpenIssuesView(issueManager,this,var_228.container);
               }
               return var_1545;
            case const_1621:
               if(var_1546 == null)
               {
                  var_1546 = new PickedIssuesView(issueManager,this,var_228.container);
               }
               return var_1546;
            default:
               return null;
