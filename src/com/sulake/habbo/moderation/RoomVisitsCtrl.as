package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(var_43.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = var_43.scrollableRegion.height > var_43.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
      ...
      private function populateRoomRow(param1:RoomVisitData, param2:Boolean) : void
      {
         ...
         new OpenRoomTool(var_46,var_44,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1847 = IWindowContainer(var_44.getXmlWindow("roomvisits_row"));
         ...
         var_46 = IFrameWindow(var_44.getXmlWindow("roomvisits_frame"));
         var_43 = IItemListWindow(var_46.findChildByName("visits_list"));
