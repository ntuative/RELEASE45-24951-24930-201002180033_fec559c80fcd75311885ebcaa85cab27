package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2185:PartOffsetData;
      
      private var var_868:AvatarActionManager;
      
      private var var_147:IAssetLibrary;
      
      private var var_2304:IAssetLibrary;
      
      private var var_1339:Boolean = false;
      
      private var var_2186:AvatarRenderManager;
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_405.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_405.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1331[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc7_:Array = var_405.getActiveParts(param3.definition);
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_405.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_405.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function onStructureReady(param1:Event = null) : void
      {
         ...
         {
            var_405.getPartDefinition("ri").appendToFigure = true;
            var_405.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_71:
               var_1535.add(new AvatarStructureDownload(var_147,_loc5_,var_497));
               break;
            case AvatarType.PET:
         }
      ...
      {
         var_868 = new AvatarActionManager(var_147,var_702);
      }
      ...
      {
         return var_2185.getOffset(param1,param2,param3,param4,param5,param6);
      }
