package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1509:AvatarDataContainer;
      
      private var _frames:Array;
      
      private var var_1510:DirectionDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               var_1271.push(new SpriteDataContainer(this as IAnimation,_loc5_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            var_1509 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc6_ in param2.canvas)
            {
               var_1270.push(new CanvasDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            var_1510 = new DirectionDataContainer(param2.direction[0]);
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               var_1269.push(new RemoveDataContainer(_loc7_));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               var_689.push(new AddDataContainer(_loc8_));
            }
         }
         var _loc3_:int = 0;
      ...
      {
         return var_1510 != null;
      }
      
      public function hasSpriteData() : Boolean
      {
         return var_1271 != null;
      }
