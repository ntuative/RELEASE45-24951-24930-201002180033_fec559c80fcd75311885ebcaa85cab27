package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1515,var_1517,var_1518,_alphaMultiplier);
         var_978 = generatePaletteMapForGrayscale(var_1982,var_1983);
      }
      
      public function get reds() : Array
      {
         return var_978.getValue("reds") as Array;
      }
      ...
      {
         return var_978.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_978.getValue("greens") as Array;
      }
      ...
      {
         return var_978.getValue("alphas") as Array;
      }
