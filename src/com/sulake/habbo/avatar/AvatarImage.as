package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1072:String = "Default";
      ...
      private var var_116:AvatarImageCache;
      ...
      private var var_485:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_187 == null)
         {
            var_187 = AvatarScaleType.const_34;
         }
         ...
         if(param5 == AvatarType.PET)
         {
            ...
            _avatarSubType = var_1013;
         }
         var_116 = new AvatarImageCache(var_65,this,_assets,var_187);
         setDirection(const_1073,const_1071);
         var_188 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1255;
         if(param2 < AvatarDirectionAngle.const_1284)
         {
            param2 = AvatarDirectionAngle.const_562 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_562)
         {
            param2 -= NaN;
         }
         if(var_702 == AvatarType.PET && param1 == AvatarSetType.const_30)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_65.sortActions(var_188);
         if(_loc1_ == null)
         {
            var_559 = new Array(0,0,0);
         }
         else
         {
            var_559 = var_65.getCanvasOffsets(_loc1_,var_187,var_87);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  var_156 = var_156.concat(_loc3_.spriteData);
                  if(_loc3_.hasDirectionData())
                  {
                     var_1255 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_485 = _loc3_.avatarData;
                  }
               }
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_373)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_65.getPartColor(var_560,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_65.getCanvas(var_187,var_166.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_702 == AvatarType.PET)
               {
                  ...
                  _loc17_ = var_65.getParts(_loc9_,var_560,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_187 == AvatarScaleType.const_81)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_65.getPartActionOffset(getSubType(),var_187,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_65.getCanvas(var_187,var_166.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_484);
            if(_loc8_ != null)
            {
               ...
               if(var_702 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_65.getParts(_loc7_,var_560,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_484);
                     _loc19_ = var_87;
                     _loc20_ = 1;
                     switch(var_87)
                     {
                     ...
                     _loc21_ = var_65.getPartActionOffset(getSubType(),var_187,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_485 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_485.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_166 = new ActiveActionData(AvatarAction.const_951);
         var_166.definition = var_65.getActionDefinition(const_1072);
      ...
      {
         return var_65.getBodyPartData(param1.animation.id,var_484,param1.id);
      }
            ...
            case AvatarAction.const_492:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1233:
                     if(var_702 == AvatarType.const_71)
                     {
                        if(var_87 == 0)
                        {
