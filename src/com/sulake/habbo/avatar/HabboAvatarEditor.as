package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1022:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1022.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1023)
         {
            ...
            _loc1_ = var_692["null"];
            _loc2_ = var_692["null"];
            _loc1_.loadAvatarData("hr-681-35.hd-209-7.ch-878-87.lg-281-70.sh-906-77.ea-1401-77.ha-1010-70.he-1601-62.fa-1204-62.ca-1809-62.wa-2007-62",FigureData.const_64);
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_63);
            var_335 = new Map();
            var_335.add(AvatarEditorCategory.const_963,new GenericModel(this));
            var_335.add(AvatarEditorCategory.const_30,new HeadModel(this));
            var_335.add(AvatarEditorCategory.const_314,new TorsoModel(this));
            var_335.add(AvatarEditorCategory.const_1246,new LegsModel(this));
            var_335.add(AvatarEditorCategory.const_555,new WardrobeModel(this));
            var_1023 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_335.getValue(AvatarEditorCategory.const_555);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_335.getValue(AvatarEditorCategory.const_555);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1022.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1554.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
                  if(_loc13_.id == _loc12_ && param2 != FigureData.const_39)
                  {
                     _loc11_ = _loc13_;
                  }
               }
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1321.clone() as IWindowContainer,param1,null,null,false);
               _loc6_.iconImage = _loc18_;
               _loc3_.push(_loc6_);
            }
            _loc14_ = param2 != FigureData.const_39;
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1336)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1321.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_335.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_399 == null)
            {
               var_399 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_38,HabboWindowStyle.const_20,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_399.addChild(_view.window);
               var_399.center();
               var_399.visible = false;
            }
            var_399.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_963);
         if(var_167 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1072 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_561,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1022 = var_1072.getFigureData(AvatarType.const_71);
      }
