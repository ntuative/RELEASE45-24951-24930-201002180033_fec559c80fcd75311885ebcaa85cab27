package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_2144 = parseInt(param1.@precedence);
         var_2145 = String(param1.@activepartset);
         var_2142 = String(param1.@assetpartdefinition);
         var_2141 = String(param1.@lay);
         var_1159 = String(param1.@geometrytype);
         var_1586 = Boolean(parseInt(param1.@main));
         var_2143 = Boolean(parseInt(param1.@method_7));
         var_2140 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_559.getValue(param1) == null)
         {
            var_559.add(param1,new Map());
         }
         var _loc4_:Map = var_559.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_559.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1268.concat(getTypePrevents(param1));
      }
