package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private var var_767:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_699.width,var_699.height,true,0);
            _loc1_.bitmap.copyPixels(var_699,var_699.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1180.width,var_1180.height,true,0);
            _loc4_ = var_1180.clone();
            _loc4_.colorTransform(_loc4_.rect,var_767.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_961.width,var_961.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_961,var_961.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1410,var_1410.rect,new Point(0,0),null,null,true);
            }
         }
      }
