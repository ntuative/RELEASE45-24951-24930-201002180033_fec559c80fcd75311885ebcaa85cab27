package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private var var_587:IFigurePartSet;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         var_1410 = _loc7_.content as BitmapData;
         _color = param4;
         if(param3 == null)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_587 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1410,var_1410.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_938 + "_" + FigureData.const_244;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1553 && _loc2_.subColorIndex)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_938 + "_" + FigureData.const_244;
