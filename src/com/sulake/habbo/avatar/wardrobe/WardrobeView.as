package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_611:IItemListWindow;
      
      private var var_509:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_727:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_611 = _window.findChildByName("mylooks") as IItemListWindow;
         var_509 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_727 = _window.findChildByName("selector") as IItemListWindow;
         var_1355 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_297,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_611.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_727.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_508 = [];
         while(true)
         {
            ...
            var_727.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_509.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_611.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_611.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_727.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_726 * 8 + var_509.getListItemIndex(param2.parent);
