package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1439 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_81);
         var_1439.setDirection(AvatarSetType.const_21,int(FigureData.const_831));
         _image = var_1439.getImage(AvatarSetType.const_21);
         _view.udpate(_image);
      }
