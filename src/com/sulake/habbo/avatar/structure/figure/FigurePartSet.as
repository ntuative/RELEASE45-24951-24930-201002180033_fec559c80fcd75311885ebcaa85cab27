package com.sulake.habbo.avatar.structure.figure
{
   public class FigurePartSet implements IFigurePartSet
   {
      ...
      public function FigurePartSet(param1:XML)
      {
         ...
         var_1694 = Boolean(parseInt(param1.@club));
         ...
         for each(_loc2_ in param1.part)
         {
            ...
            if(_loc5_ != -1)
            {
               var_523.splice(_loc5_,0,_loc4_);
            }
            else
            {
               var_523.push(_loc4_);
         ...
         {
            var_1430.push(String(_loc3_.@parttype));
         }
      }
