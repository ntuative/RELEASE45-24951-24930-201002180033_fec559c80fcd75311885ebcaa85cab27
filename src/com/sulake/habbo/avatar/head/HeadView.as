package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_105,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_119,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_115,param2,param3);
         var_648["null"] = new AvatarEditorGridView(param1,FigureData.const_125,param2,param3);
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1050);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_648[var_1380];
         if(_loc2_ == null)
         {
            return;
         }
