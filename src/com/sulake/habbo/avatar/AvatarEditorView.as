package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1554:IWindowContainer;
      
      public static var var_1321:IWindowContainer;
      
      public static var var_1050:int = 6710886;
      ...
      private var var_1492:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1321 == null)
         {
            ...
            var_1321 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1554 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1554 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_659 != null)
         {
            toggleCategoryView(var_659,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1492 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_659 = param1;
         var_1492.setSelected(var_1492.getSelectableByName(param1));
         _window.invalidate();
      }
