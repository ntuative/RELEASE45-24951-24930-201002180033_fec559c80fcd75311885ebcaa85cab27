package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1459:uint = 13232628;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_44.localization.registerParameter("help.tutorial.name.available","name",var_385);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_385 = var_44.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_44.localization.registerParameter("help.tutorial.name.confirmation","name",var_385);
         }
         if(var_244 == null)
         {
            var_244 = var_44.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_244 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1555:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1557:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1557 || param1 == ChangeUserNameResultMessageEvent.var_1555)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_800 = new NameSuggestionListRenderer(var_44);
         var _loc6_:int = var_800.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1459;
