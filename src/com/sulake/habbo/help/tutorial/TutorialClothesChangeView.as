package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_44.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_28,onShowMenuEvent);
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  var_44.showView(TutorialUI.const_61);
               }
         }
      }
      ...
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_28)
         {
            setToolbarIconHighlight(false);
            hideToolbarIconHighlightArrow();
            var_44.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_359));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_513 = var_44.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_513.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         var_44.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_28,HabboToolbarIconEnum.MEMENU_ARROW,var_513));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_44.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_28,onShowMenuEvent);
      }
   }
}
