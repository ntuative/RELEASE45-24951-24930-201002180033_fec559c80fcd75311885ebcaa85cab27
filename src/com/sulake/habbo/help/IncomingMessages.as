package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onChangeUserNameResult(param1:IMessageEvent) : void
      {
         ...
         var_27.tutorialUI.onChangeUserNameResult(param1 as ChangeUserNameResultMessageEvent);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_27.tellUI(HabboHelpViewEnum.const_197,_loc4_);
         }
      }
      ...
      private function onUserNameChange(param1:IMessageEvent) : void
      {
         ...
         var_27.ownUserName = _loc2_.newName;
         if(true)
         {
            return;
         }
         var_27.tutorialUI.onUserNameChanged(_loc2_.newName);
      }
      ...
      private function onRoomEntryInfo(param1:IMessageEvent) : void
      {
         ...
         {
            var_27.enableCallForGuideBotUI();
         }
         else
         {
            var_27.disableCallForGuideBotUI();
         }
      }
      ...
      private function onCallForHelpResult(param1:IMessageEvent) : void
      {
         ...
         var_27.showCallForHelpResult(_loc4_);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_27.tellUI(HabboHelpViewEnum.const_252,_loc6_);
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         var_27.tutorialUI.onUserChanged();
      }
      ...
      private function onCallForHelpReply(param1:IMessageEvent) : void
      {
         ...
         var_27.showCallForHelpReply(_loc2_.message);
      }
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_27.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + getCloseReasonKey(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_27.tellUI(HabboHelpViewEnum.const_126);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         _userId = _loc2_.id;
         var_27.ownUserName = _loc2_.name;
      }
      
      private function onPendingCallsForHelpDeleted(param1:IMessageEvent) : void
      {
         var_27.showUI(HabboHelpViewEnum.const_315);
      }
      ...
      private function onTutorialStatus(param1:IMessageEvent) : void
      {
         ...
         var_27.updateTutorial(_loc2_.hasChangedLooks,_loc2_.hasChangedName,_loc2_.hasCalledGuideBot);
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         var_27.userRegistry.registerRoom(var_27.localization.getKey(_loc3_));
      }
      ...
      private function onGuestRoomResult(param1:IMessageEvent) : void
      {
         ...
         var_27.userRegistry.registerRoom(_loc2_.data.roomName);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_27.showUI(HabboHelpViewEnum.const_420);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_27.showUI(HabboHelpViewEnum.const_651);
         var_27.tellUI(HabboHelpViewEnum.const_651,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_386)
            {
               var_27.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
         ...
         var_27.tellUI(HabboHelpViewEnum.const_714);
      }
