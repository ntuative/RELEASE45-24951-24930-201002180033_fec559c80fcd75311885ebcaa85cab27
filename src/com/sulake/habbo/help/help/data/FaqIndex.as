package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      public function FaqIndex()
      {
         ...
         var_656 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_121 = new Map();
      }
      
      public function getCategory(param1:int, param2:String = null, param3:Boolean = false) : FaqCategory
      {
         var _loc4_:FaqCategory = var_121.getValue(param1);
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_656.hasItem(param1))
         {
            var_656.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_121.length)
         {
            _loc4_ = var_121.getWithIndex(_loc3_);
      ...
      public function dispose() : void
      {
         ...
         if(var_121 != null)
         {
            ...
            {
               _loc2_ = var_121.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
            var_121.dispose();
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(var_656.hasItem(param1))
         {
            return var_656.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < var_121.length)
         {
            _loc3_ = var_121.getWithIndex(_loc2_);
