package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_732:String = "selection_arrow";
      ...
      private static const const_324:String = "place_holder";
      
      private static const const_1033:String = const_324;
      ...
      private var var_152:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_445 = [];
         _wallItems = [];
         var_1765 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1759 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_368 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_276,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_95 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_152 != null && var_152.hasWorldType(const_258 + param1))
         {
            return var_152.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_444.add(_loc10_,_loc11_);
                              if(var_445.indexOf(_loc14_) < 0)
                              {
                                 var_445.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_368 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_368.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_321 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_321.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_368.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = var_368.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_324,const_467,ROOM_CONTENT,const_731,const_732];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1765.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_157 && _loc5_ != RoomObjectLogicEnum.const_95)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_152 != null && (var_152.type == param1 || var_152.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1033;
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_369 != null)
         {
            _loc2_ = var_369.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1365);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1759.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_276,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_344,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_152 != null && (var_152.type == param1 || var_152.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_41;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_41;
      ...
      private function continueInitilization() : void
      {
         if(var_1760)
         {
            ...
            if(var_947 != null)
            {
               var_947.dispatchEvent(new Event(const_696));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_152 != null)
         {
            return var_152.getWorldHeightScale(const_258 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_947 = param1;
            var_1761 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1762 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1764 = param2.getKey("public.room.dynamic.download.url","");
            var_1763 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_730;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_321.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_369 != null)
         {
            var_369.remove(param1);
            var_369.add(param1,param2);
         }
         if(var_367 != null)
         {
            var_367.remove(param2);
            var_367.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_157 && _loc5_ != RoomObjectVisualizationEnum.const_95)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_258 + param1) == RoomObjectCategoryEnum.const_41)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_152 = var_1148.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_152 != null)
         {
            return var_152.getWorldScale(const_258 + param1);
         }
         return 32;
      }
