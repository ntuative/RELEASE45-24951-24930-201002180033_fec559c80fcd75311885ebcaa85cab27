package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_760:String = "overlay";
      ...
      private static const const_261:int = -1;
      ...
      private var var_482:IAdManager = null;
      
      private var var_584:NumberBank;
      
      private var var_34:IRoomManager = null;
      ...
      private var var_58:RoomObjectEventHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_294 = new Map();
         var_584 = new NumberBank(1000);
         var_1043 = new Map();
         var_295 = new Map();
         var_58 = new RoomObjectEventHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_58 != null)
         {
            ...
            {
               return var_58.deleteWallItem(var_110,var_109,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_34.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_653) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_598) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_600) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_567) + 0.5;
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_58.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_58 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_12)
            {
               return var_58.modifyWallItemData(var_110,var_109,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.release(new IIDRoomManager());
            var_34 = null;
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_34.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_897;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_649);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_708);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_626);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_809);
      ...
      {
         var _loc4_:IRoomInstance = var_34.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_777) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_851);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_395,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_556,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_490,var_110,var_109,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_58 != null)
         {
            return var_58.modifyRoomObject(var_110,var_109,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_295.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_295.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_712,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_647,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34 = param2 as IRoomManager;
         if(var_34 != null)
         {
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_13);
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_12);
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_19);
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_221);
            var_34.addObjectUpdateCategory(RoomObjectCategoryEnum.const_41);
            var_34.setContentLoader(var_9);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_58 != null)
         {
            var_58.handleRoomObjectEvent(param1,var_110,var_109);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_263,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_295,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_797,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_986,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_822,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_213,param1,param2,param3,RoomObjectCategoryEnum.const_13));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_394 == null || var_34 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2212)
         {
            return;
         }
         var_34.initialize(<nothing/>,this);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_261,RoomObjectCategoryEnum.const_41);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1201,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_34 != null)
         {
            var_34.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_34.getRoom(getRoomIdentifier(var_110,var_109));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_761,RoomObjectCategoryEnum.const_221);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_110,var_109,var_1308);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_110,var_109,var_1308);
         if(_loc1_ != null)
         {
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_434,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_446,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_239,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_495,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_98,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_88,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_94,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_384,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_403,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_464,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_368,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_375,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_438,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_460,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_247,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_406,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_871,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_332,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_426,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_644) != 0)
         {
            return false;
         }
         if(var_58 != null)
         {
            return var_58.initializeRoomObjectInsert(var_110,var_109,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_295.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_213,param1,param2,param3,RoomObjectCategoryEnum.const_19));
         }
         return true;
      }
      ...
      {
         return var_34.isContentAvailable(param1);
      }
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_34.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_19:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_147);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_294);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_263,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_295,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_897,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_213,param1,param2,param3,RoomObjectCategoryEnum.const_12));
         }
         return true;
      }
      ...
      {
         var _loc5_:IRoomInstance = var_34.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_482 = param2 as IAdManager;
         var_482.events.addEventListener(AdEvent.const_419,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_760) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_58 != null)
         {
            var_58.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_58 != null)
         {
            return var_58.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_34.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         var _loc10_:IRoomInstance = var_34.getRoom(const_477);
         if(_loc10_ == null)
         {
            _loc10_ = var_34.createRoom(const_477,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_584.reserveNumber();
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               break;
            case RoomObjectCategoryEnum.const_19:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_147,param2);
               break;
            case RoomObjectCategoryEnum.const_41:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_130,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc21_.addPlane(RoomPlaneData.const_116,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_116,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_668,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_570,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_629,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_395,_loc24_,param6,new Vector3d(2,0,1.75));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_759,RoomObjectCategoryEnum.const_221);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1541 - _loc12_.width / 2;
               _loc11_.y = var_1542 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_382,var_110,var_109,-1,RoomObjectCategoryEnum.const_178));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_58 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_261,const_476);
                  var_58.handleRoomObjectEvent(_loc14_,var_110,var_109);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_110,var_109,var_1308);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1541 - _loc6_.data.width / 2;
               _loc11_.y = var_1542 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_283,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_888,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_832,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_766,RoomObjectVariableEnum.const_283,param1.clickUrl);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_58 != null)
         {
            var_58.cancelRoomObjectInsert(var_110,var_109);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_34.getRoom(const_477);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return getRoomObjectBoundingRectangle(var_110,var_109,const_261,RoomObjectCategoryEnum.const_41,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_34.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         var _loc8_:int = _loc8_ = RoomObjectCategoryEnum.const_41;
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(isPublicRoomWorldType(param6))
         {
            _loc12_ = var_9.getPublicRoomContentType(param6);
            _loc9_ = _loc7_.createRoomObject(const_261,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_911,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_644,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_898,_loc13_,true);
            if(var_9 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_261,const_476,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_644,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_649,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_653,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_600,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_598,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_567,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_787,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_712,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_647,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_395,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_202);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_708,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_626,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_708,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_626,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_809,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_759,const_1103,RoomObjectCategoryEnum.const_221);
         _loc7_.createRoomObject(const_761,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_221);
         return _loc7_;
      }
