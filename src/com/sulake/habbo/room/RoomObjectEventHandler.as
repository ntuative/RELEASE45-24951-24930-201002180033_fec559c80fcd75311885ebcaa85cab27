package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_891);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_587);
         }
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_19 && _loc3_.typeId == RoomObjectTypeEnum.const_277)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_172,param1,param2,_loc4_,_loc5_));
         }
         resetSelectedObjectData(param1,param2);
      }
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_645,param1,param2,param3,param4));
         }
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_187,param2);
         }
      }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_13)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_587);
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = getMouseEventId(RoomObjectCategoryEnum.const_178,MouseEvent.CLICK);
         switch(_loc4_)
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc8_ == RoomObjectCategoryEnum.const_41)
               {
                  if(_loc5_ != null)
                  {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_19)
                  {
                     if(_loc10_ != null)
                     {
                        setMouseEventId(RoomObjectCategoryEnum.const_41,MouseEvent.CLICK,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_41)
         {
            _loc12_ = getMouseEventId(RoomObjectCategoryEnum.const_41,MouseEvent.CLICK);
            if(_loc12_ != _loc10_)
            {
               _loc13_ = _roomEngine.events;
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_382,param2,param3,-1,RoomObjectCategoryEnum.const_178));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_13 || _loc8_ == RoomObjectCategoryEnum.const_12)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_510,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_247:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_193:
               ...
               break;
            case RoomObjectMouseEvent.const_434:
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = _roomEngine.getRoomObject(roomId,roomCategory,var_997,category) as IRoomObjectController;
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_415:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_332:
      ...
      {
         var _loc3_:Map = var_554.getValue(String(param1)) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         var _loc4_:Map = var_554.getValue(String(param1)) as Map;
         if(_loc4_ == null)
         {
            _loc4_ = new Map();
            var_554.add(param1,_loc4_);
         }
      ...
      private function handleRoomObjectMouseMove(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectOperationEnum.OBJECT_MOVE:
               if(_loc7_ == RoomObjectCategoryEnum.const_41)
               {
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_239:
               ...
               break;
            case RoomObjectStateChangeEvent.const_495:
            ...
            case RoomObjectRoomAdEvent.const_296:
               ...
               break;
            case RoomObjectRoomActionEvent.const_415:
            case RoomObjectRoomActionEvent.const_871:
            case RoomObjectRoomActionEvent.const_332:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_993));
               break;
            case RoomObjectFurnitureActionEvent.const_368:
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:String, param4:IRoomGeometry) : void
      {
         ...
         var _loc6_:int = _roomEngine.getRoomObjectCategory(_loc5_);
         if(_loc6_ != RoomObjectCategoryEnum.const_41)
         {
            _loc6_ = 0;
         }
