   ...
   public class RoomTileCursorLogic extends ObjectLogicBase
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_62,Number(false));
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_428)
            {
               if(_loc3_ != null)
               {
                  _loc3_.setNumber(RoomObjectVariableEnum.const_62,Number(true));
               }
            }
            else if(_loc2_.type == RoomObjectVisibilityUpdateMessage.const_376)
            {
               if(_loc3_ != null)
               {
                  _loc3_.setNumber(RoomObjectVariableEnum.const_62,Number(false));
               }
            }
         }
      }
