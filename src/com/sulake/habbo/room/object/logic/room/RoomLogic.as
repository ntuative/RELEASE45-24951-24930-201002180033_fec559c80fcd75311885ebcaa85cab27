package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1193:uint = 16777215;
      
      private var var_977:uint = 16777215;
      
      protected var var_70:RoomPlaneParser = null;
      
      private var var_781:int = 0;
      
      private var var_1083:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_702:
                  _loc2_.setString(RoomObjectVariableEnum.const_668,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_712:
                  _loc2_.setString(RoomObjectVariableEnum.const_570,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_647:
                  _loc2_.setString(RoomObjectVariableEnum.const_629,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_395:
                  _loc8_ = "null";
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_812,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_807,int(_loc5_.bgOnly));
            var_1193 = _color;
            var_1434 = var_1083;
            var_977 = _loc11_;
            var_1433 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!var_70.initializeFromXML(param1))
         {
            return;
         }
         var _loc2_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_876,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_539,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_70.planeCount)
         {
            if(param1.type == MouseEvent.ROLL_OUT)
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_62,0);
            }
            return;
         }
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_70.getPlaneLocation(_loc5_);
         var _loc9_:IVector3d = var_70.getPlaneLeftSide(_loc5_);
         var _loc10_:IVector3d = var_70.getPlaneRightSide(_loc5_);
         var _loc11_:IVector3d = var_70.getPlaneNormalDirection(_loc5_);
         var _loc12_:IVector3d = var_70.getPlaneNormal(_loc5_);
         var _loc13_:int = var_70.getPlaneType(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1308,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1345,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1361,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_62,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_130)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_116 || _loc13_ == RoomPlaneData.const_233)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_781)
         {
            ...
            {
               _loc7_ = var_1193 >> 16 & 255;
               _loc8_ = var_1193 >> 8 & 255;
               _loc9_ = var_1193 & 255;
               _loc10_ = var_977 >> 16 & 255;
               _loc11_ = var_977 >> 8 & 255;
               _loc12_ = var_977 & 255;
               _loc13_ = (_loc2_ - var_781) / var_1432;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1434 + (var_1433 - var_1434) * _loc13_;
               _color = _loc3_;
               var_1083 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_539,_loc3_);
         }
      }
   }
}
