package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1013:int = 3;
      
      private const const_1592:int = 2;
      
      private var var_721:AvatarVisualizationData = null;
      ...
      {
         var_721 = param1 as AvatarVisualizationData;
         createSprites(const_1014);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_147);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_525);
         ...
         var _loc14_:Number = _loc8_ - var_1079;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_262);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_267 != _loc3_.getUpdateID() || var_196 != param1.scale || var_149 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_420 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_420;
            _loc23_ = getTimer();
            if(var_560 != _loc7_)
            {
               for each(_loc49_ in var_360.getKeys())
               {
                  var_360.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_721.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_294);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_251) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_30,_loc25_);
            _loc6_.initActionAppends();
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_251);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_595);
            _loc6_.appendAction(AvatarAction.const_492,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_402);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_267,AvatarAction.const_1330[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_817);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_921,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_939);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_914);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_980,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_630);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_631);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_932,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_989);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_978,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_361);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_372) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_529);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_373);
            }
            ...
            _loc43_ = getSprite(const_1592);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_915))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_721.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_720.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_720)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
