   ...
   public class PlaneMaskManager
   {
      ...
      private function parseMasks(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc6_ < _loc5_.length())
         {
            ...
            {
               _loc8_ = _loc7_.@id;
               if(var_143.getValue(_loc8_) == null)
               {
      ...
      public function updateMask(param1:BitmapData, param2:String, param3:Number, param4:IVector3d, param5:int, param6:int) : Boolean
      {
         ...
         var _loc15_:* = NaN;
         var _loc16_:* = NaN;
         var _loc7_:PlaneMask = var_143.getValue(param2) as PlaneMask;
         if(_loc7_ != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_143 != null)
         {
            ...
            {
               _loc2_ = var_143.getWithIndex(_loc1_) as PlaneMask;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
