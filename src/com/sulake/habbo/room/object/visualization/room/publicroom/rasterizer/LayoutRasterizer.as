package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_920:Point = null;
      
      private var var_427:Array;
      
      private var var_918:LayoutRasterizerData = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_919 = param1;
         var _loc3_:LayoutRasterizerData = var_54.getValue(var_610);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1093 = RoomObjectVariableEnum.const_888;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1093 = RoomObjectVariableEnum.const_832;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_919 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_919 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_919 + _adBgIndex);
            _loc5_ = param1.getSprite(var_919 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1093);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1613);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_610)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_918 = var_54.getValue(var_610);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_54.getValue(var_610);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_918.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_920.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_920.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_309.indexOf(_loc10_) >= 0 && var_426)
            {
               ...
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_428[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
