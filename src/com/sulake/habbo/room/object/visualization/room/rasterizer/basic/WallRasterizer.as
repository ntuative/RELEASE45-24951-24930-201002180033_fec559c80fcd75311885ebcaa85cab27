package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class WallRasterizer extends PlaneRasterizer
   {
      ...
      private function parseWalls(param1:XML) : void
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               if(var_308.getValue(_loc5_) == null)
               {
                  var_308.add(_loc5_,_loc7_);
               }
               else
               {
                  _loc7_.dispose();
      ...
      {
         var _loc13_:WallPlane = var_308.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_308.getValue(const_716);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_308 != null)
         {
            ...
            {
               _loc2_ = var_308.getWithIndex(_loc1_) as WallPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
