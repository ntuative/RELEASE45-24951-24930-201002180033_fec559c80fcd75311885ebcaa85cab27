package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1212:int = const_313;
      ...
      public static const const_254:int = const_83;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1656 = param6;
         var_1655 = param7;
         var_732 = new Vector3d();
         if(var_1362 == const_531)
         {
            var_1110 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1363 == const_83)
         {
            _loc5_ = new Rectangle(0,0,var_23.width,var_429);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_429,var_23.width,var_429);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_23 != null)
            {
               if(var_23.width == param2 && var_23.height == param3 && Vector3d.isEqual(var_732,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_429,param6,param7);
                     return param1;
                  }
                  return var_23;
               }
