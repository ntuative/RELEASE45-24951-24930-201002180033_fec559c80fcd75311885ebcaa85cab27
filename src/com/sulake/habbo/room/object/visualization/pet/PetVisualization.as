package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_721:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_945);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_929)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_961);
               var_420 = const_1013;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_251);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_267 != _loc3_.getUpdateID() || var_196 != param1.scale || var_149 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_420 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            _loc18_ = getTimer();
            --var_420;
            if(var_560 != _loc7_)
            {
               for each(_loc36_ in var_360.getKeys())
               {
                  var_360.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_294);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc6_.setDirectionAngle(AvatarSetType.const_30,_loc20_);
            _loc6_.initActionAppends();
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_251);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_595);
            _loc6_.appendAction(AvatarAction.const_492,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_402);
               _loc39_ = 3;
               _loc40_ = _loc8_ - _loc38_;
               if(_loc40_ < _loc39_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_267,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_372) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1014;
            ...
            _loc31_ = getSprite(const_1592);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_721.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_720.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_720)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_721 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
