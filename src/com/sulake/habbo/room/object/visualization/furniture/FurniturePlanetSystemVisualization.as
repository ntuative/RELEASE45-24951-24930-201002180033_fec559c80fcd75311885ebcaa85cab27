package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_791);
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_220 != null)
         {
            ...
            {
               _loc2_ = var_220[_loc3_];
               _loc2_.update(var_562,var_2117,param1);
               _loc3_++;
            }
