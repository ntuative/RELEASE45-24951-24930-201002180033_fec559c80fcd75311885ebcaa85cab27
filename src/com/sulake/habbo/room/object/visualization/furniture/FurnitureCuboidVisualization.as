   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_92.length)
         {
            ...
            _loc9_ = var_92[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + var_1405;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_92 != null)
         {
            ...
            {
               _loc2_ = var_92[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
