package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_433:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_433 = var_234.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_433 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_234 != null)
         {
            ...
            {
               _loc1_ = var_234.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_234.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_234.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
