package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class AnimationData
   {
      ...
      {
         var _loc5_:AnimationLayerData = var_162.getValue(param1) as AnimationLayerData;
         if(_loc5_ != null)
         {
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         var_162.add(param1,_loc6_);
         return true;
      }
      
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         var _loc3_:AnimationLayerData = var_162.getValue(param1) as AnimationLayerData;
         if(_loc3_ != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_162 != null)
         {
            ...
            {
               _loc2_ = var_162.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
