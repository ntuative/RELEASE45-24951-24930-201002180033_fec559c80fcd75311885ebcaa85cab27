package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_557 = new Vector3d();
         var_557.assign(param2);
         var_558 = new Vector3d();
         var_558.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2094)
         {
            if(!param1)
            {
               var_248.assign(var_557);
               var_249.assign(var_558);
            }
            else
            {
               var_248.assign(var_557);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_64 == null && var_805 != null || var_248 == null || var_249 == null || var_480 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1250)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1010 || _loc4_.y != var_1960 || _loc4_.z != var_1964 || param1.scale != var_1961))
            {
               var_1010 = _loc4_.x;
               var_1960 = _loc4_.y;
               var_1964 = _loc4_.z;
