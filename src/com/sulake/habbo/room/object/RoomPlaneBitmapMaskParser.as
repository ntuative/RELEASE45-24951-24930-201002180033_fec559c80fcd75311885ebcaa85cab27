package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneBitmapMaskParser
   {
      ...
      public function getMaskCategory(param1:int) : String
      {
         ...
         var _loc2_:RoomPlaneBitmapMaskData = var_143.getWithIndex(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
      ...
      public function addMask(param1:String, param2:String, param3:IVector3d, param4:String) : void
      {
         ...
         var_143.remove(param1);
         var_143.add(param1,_loc5_);
      }
      ...
      public function reset() : void
      {
         ...
         {
            _loc2_ = var_143.getWithIndex(_loc1_) as RoomPlaneBitmapMaskData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         var _loc2_:RoomPlaneBitmapMaskData = var_143.remove(param1) as RoomPlaneBitmapMaskData;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
