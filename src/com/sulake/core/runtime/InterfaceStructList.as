package com.sulake.core.runtime
{
   ...
   final class InterfaceStructList implements IDisposable
   {
      ...
      {
         var_43.push(param1);
         return var_43.length;
      }
      
      public function remove(param1:uint) : InterfaceStruct
      {
         var _loc2_:* = null;
         if(param1 < var_43.length)
         {
            _loc2_ = var_43[param1];
            var_43.splice(param1,1);
            return _loc2_;
         }
      ...
      public function mapStructsByInterface(param1:IID, param2:Array) : uint
      {
         ...
         while(_loc7_ < _loc6_)
         {
            _loc5_ = var_43[_loc7_] as InterfaceStruct;
      ...
      public function getStructByImplementor(param1:IUnknown) : InterfaceStruct
      {
         ...
         while(_loc4_ < _loc3_)
         {
            _loc2_ = var_43[_loc4_] as InterfaceStruct;
      ...
      public function getIndexByInterface(param1:IID) : int
      {
         ...
         while(_loc5_ < _loc4_)
         {
            _loc3_ = var_43[_loc5_] as InterfaceStruct;
      ...
      {
         return param1 < var_43.length ? var_43[param1] : null;
      }
      ...
      public function mapStructsByImplementor(param1:IUnknown, param2:Array) : uint
      {
         ...
         while(_loc6_ < _loc5_)
         {
            _loc4_ = var_43[_loc6_] as InterfaceStruct;
      ...
      public function find(param1:IID) : IUnknown
      {
         ...
         while(_loc5_ < _loc3_)
         {
            _loc4_ = var_43[_loc5_] as InterfaceStruct;
