package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1442:uint = 1;
      ...
      protected var var_1062:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_885:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_885 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_885);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1062 & const_811)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_403 + "]";
      }
   }
}
