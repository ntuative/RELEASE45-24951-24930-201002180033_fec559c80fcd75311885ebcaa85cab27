package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_479:uint = 0;
      
      private static const const_763:uint = 2;
       
      
      private var var_1317:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_763)
            {
               Core.crash("Error catched in EventDispatcher; some event listener crashed!",var_1317.errorID,var_1317);
            }
            return _result == const_479;
         }
         return false;
      }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1110) : uint(const_479);
      }
