package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1055:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_28 = new Array();
         var_506 = new Array();
         var_1055 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_350 = new AssetLibrary("lib-" + var_597++);
         var_28.push(var_350);
      }
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_506.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_506.length)
            {
               _loc3_ = var_506[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_506.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
