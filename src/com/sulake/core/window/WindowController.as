package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_89,WindowParam.const_127);
         var _loc2_:* = !testParamFlag(WindowParam.const_93,WindowParam.const_123);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_280)
               {
                  _loc3_.x += _loc4_;
               }
      ...
      {
         var_714 = param1;
         var_592 = !!var_714 ? uint(var_592 | var_1337) : uint(var_592 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1921 + "]";
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_775,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function restore() : Boolean
      {
         ...
         setStateFlag(WindowState.const_40,false);
      ...
      public function minimize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_40,true);
      ...
      {
         var_400 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function swapChildren(param1:IWindow, param2:IWindow) : void
      {
         ...
         if(param1 != null && param2 != null && param1 != param2)
         {
            ...
            {
               var_12.method_6(WindowController(param1).getGraphicContext(true),WindowController(param2).getGraphicContext(true));
            }
         }
      }
      ...
      {
         var_1337 = param1 & 4278190080;
         var_592 = !!var_714 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_55);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_571))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_889;
                  if(testParamFlag(WindowParam.const_310))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_181))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_181))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_205:
                  ...
                  if(param1 == this)
                  {
                     ...
                     else if(testParamFlag(WindowParam.const_152,WindowParam.const_123))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        _loc8_ = uint(var_13);
                        var_13 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_343))
                        {
                           var_6.width += 0 - 0;
                        }
                        ...
                        var_13 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_219,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_433:
                  _context.invalidate(this,var_5.union(var_47),WindowRedrawFlag.const_416);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_764,this,null));
                     if(var_6 != null)
                     {
               ...
               case WindowNotifyEvent.const_309:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_581,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_176,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_346:
               ...
               case WindowNotifyEvent.const_445:
                  if(!(var_13 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_416);
                     }
                  }
                  else if(var_13 & 0)
                  {
               ...
               case WindowNotifyEvent.const_176:
                  ...
                  break;
               case WindowNotifyEvent.const_443:
                  var_6.getRegionProperties(null,var_279);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_292:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_675,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_496;
         update(this,_loc1_);
         return true;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_13 & 0);
            if(_loc7_ == WindowParam.const_370)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_601,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_433,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_205,this,null));
            }
         }
      }
      ...
      {
         if(getStateFlag(WindowState.const_40))
         {
            return true;
         }
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1333,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_150 && var_711 > 0)
         {
            if(!testParamFlag(WindowParam.const_14))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1413,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1413,param3,param1)) : false;
            }
         }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_55);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_279 = var_6.rectangle.clone();
               var_47.x = var_5.x;
               var_47.y = var_5.y;
               var_47.width = var_5.width;
               var_47.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_334,this,var_6));
            }
            else
            {
               var_279.x = 0;
               ...
               var_279.width = 0;
               var_279.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_839,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_73,var_13,_context,var_5,null,var_590,properties,var_593.concat(),_id) as WindowController;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_530;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_772,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         if(var_31 == WindowState.const_447)
         {
            return true;
         }
