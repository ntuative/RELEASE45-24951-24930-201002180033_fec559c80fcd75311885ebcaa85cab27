package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1978 = new Dictionary();
         TypeCodeTable.fillTables(var_1431,var_1978);
         var_1192 = new Dictionary();
         var_1979 = new Dictionary();
         StateCodeTable.fillTables(var_1192,var_1979);
         ...
         {
            var_351 = new Array();
            var_351.push(WindowState.const_40);
            var_351.push(WindowState.const_47);
            var_351.push(WindowState.const_72);
            var_351.push(WindowState.const_29);
            var_351.push(WindowState.const_57);
            var_351.push(WindowState.const_53);
            var_351.push(WindowState.const_69);
            var_351.push(WindowState.const_65);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1192)
         {
            _loc3_.push(var_1192[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1431[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_543[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_543[param1] = new Array(SkinContainer.const_1052);
         }
         var_543[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_543[_loc1_]).dispose();
