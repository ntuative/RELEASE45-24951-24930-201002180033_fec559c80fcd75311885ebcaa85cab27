package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_588:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_588 = new Dictionary(false);
         var_589 = new Dictionary(false);
         var_640 = new Matrix();
      }
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_588[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  _loc13_.x += param3.x;
                  _loc13_.y += param3.y;
                  if(_loc11_.scaleH == SkinLayoutEntity.const_224)
                  {
                     _loc13_.x += _loc16_;
                  }
                  ...
                  if(_loc11_.scaleV == SkinLayoutEntity.const_224)
                  {
                     _loc13_.y += _loc17_;
                  }
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_640 = null;
         for(_loc1_ in var_588)
         {
            _loc2_ = var_588[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_588[_loc1_];
         }
         var_588 = null;
         for(_loc1_ in var_589)
         {
            _loc2_ = var_589[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_589[_loc1_];
         }
         var_589 = null;
      }
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_589[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_224)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_224)
               {
