package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_282 = new Rectangle();
         var_281 = new Dictionary(true);
         var_601 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_281[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_282.x = _loc3_.dirty.x;
               var_282.y = _loc3_.dirty.y;
               var_282.width = _loc3_.dirty.width;
               var_282.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_282);
            }
            _loc4_++;
         }
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_601);
            var_281[param1] = _loc2_;
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_55);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_282.x = param2.x - param1.x;
            var_282.y = param2.y - param1.y;
            var_282.width = param2.width;
            var_282.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_14))
            {
               while(param1.testParamFlag(WindowParam.const_14))
               {
                  ...
                  var_282.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_282,WindowRedrawFlag.const_248);
