package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1523:String = "_INCLUDE";
      
      public static const const_952:String = "_EXCLUDE";
      
      public static const const_1461:String = "_TEMP";
      
      private static const const_1038:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1037:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1057:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_886:Dictionary;
      
      protected var var_1326:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1058,var_1057);
         var_886 = new Dictionary();
         var_1327 = new Dictionary();
         ParamCodeTable.fillTables(var_886,var_1327);
         var_1326 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1037,"");
         return param1.replace(const_1038,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1057)
            {
               delete var_1057[_loc1_];
            }
            for(_loc1_ in var_886)
            {
               delete var_886[_loc1_];
            }
            for(_loc1_ in var_1327)
            {
               delete var_1327[_loc1_];
            }
            var_1326.dispose();
            var_1326 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_952) == -1)
                  {
