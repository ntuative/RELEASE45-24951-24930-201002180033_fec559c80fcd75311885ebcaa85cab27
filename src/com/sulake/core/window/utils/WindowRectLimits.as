package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_388:int = -2147483648;
      ...
      {
         return var_389 == int.MIN_VALUE && var_390 == int.MAX_VALUE && var_388 == int.MIN_VALUE && var_387 == int.MAX_VALUE;
      }
      ...
      {
         var_387 = param1;
         if(var_387 < int.MAX_VALUE && true && _target.height > var_387)
         {
      ...
      {
         var_388 = param1;
         if(var_388 > int.MIN_VALUE && true && _target.height < var_388)
         {
