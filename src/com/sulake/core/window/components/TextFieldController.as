package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_748:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_12)
         {
            var_12 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_TEXTFIELD,var_5);
         }
         return var_12;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_893,PropertyStruct.const_37,var_893 != false));
         return _loc1_;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_748 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
