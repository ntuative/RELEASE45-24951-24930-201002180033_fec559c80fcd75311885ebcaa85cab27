package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_505:String = "none";
      
      protected var var_594:Number;
      
      protected var var_349:Number;
      ...
      {
         return new Rectangle(var_594 * maxScrollH,var_349 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_716)
         {
            context.removeLocalizationListener(var_302,this);
         }
         if(var_60 != null)
         {
            var_60.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_302 = param1;
         if(var_302.charAt(0) == "$" && var_302.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_302.slice(2,var_302.indexOf("}")),this);
            var_716 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_987,true));
         ...
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_37,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_348,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_43,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_482,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_482,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_37,true));
         _loc1_.push(new PropertyStruct("margin_left",var_60.left,PropertyStruct.const_43,true));
         _loc1_.push(new PropertyStruct("margin_top",var_60.top,PropertyStruct.const_43,true));
         _loc1_.push(new PropertyStruct("margin_right",var_60.right,PropertyStruct.const_43,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_60.bottom,PropertyStruct.const_43,true));
         _loc1_.push(new PropertyStruct("auto_size",var_505,PropertyStruct.STRING,var_505 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_37,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_37,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_37,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_37,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_482,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_505 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_505 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_505 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_505 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
