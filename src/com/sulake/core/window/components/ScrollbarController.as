package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_470:String = "slider_bar";
      
      private static const const_1044:String = "decrement";
      
      private static const const_737:String = "slider_track";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_470:
      ...
      {
         return findChildByName(ScrollbarController.const_737) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_470) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_771 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_771 != null)
         {
            _loc1_ = findParentByName(var_771) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_771) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_33)
         {
            ...
            else if(param2.name == ScrollbarController.const_1044)
            {
               if(var_19)
               {
                  var_539 = true;
            ...
            else if(param2.name == ScrollbarController.const_737)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_470).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_904)
         {
