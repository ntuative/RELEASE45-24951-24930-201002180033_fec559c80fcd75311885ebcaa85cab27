package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_12)
         {
            var_12 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_DESKTOP,var_5);
            GraphicContext(var_12).mouseEnabled = true;
            GraphicContext(var_12).doubleClickEnabled = true;
         }
         return var_12;
      }
