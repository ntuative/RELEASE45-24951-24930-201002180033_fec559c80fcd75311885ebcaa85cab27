package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_998:String = "resize_on_item_update";
      
      protected static const const_999:String = "spacing";
      ...
      protected static const const_996:String = "auto_arrange_items";
      ...
      protected var var_715:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_150 = var_714 || !testParamFlag(WindowParam.const_14);
         _container = _context.create("_CONTAINER","",WindowType.const_300,WindowStyle.const_287,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_307,containerEventHandler);
         _container.addEventListener(WindowEvent.const_452,containerEventHandler);
         resizeOnItemUpdate = var_1064;
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_307,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != var_503)
         {
            ...
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_55);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_999,_spacing,PropertyStruct.const_43,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_996,var_715,PropertyStruct.const_37,var_715 != const_1372));
         _loc1_.push(new PropertyStruct(const_997,var_502,PropertyStruct.const_37,var_502 != const_1373));
         _loc1_.push(new PropertyStruct(const_998,var_1064,PropertyStruct.const_37,var_1064 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_998:
                  ...
                  break;
               case const_996:
                  var_715 = _loc2_.value as Boolean;
                  break;
            }
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_343,param1);
            }
            else
            {
