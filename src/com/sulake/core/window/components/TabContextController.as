package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1562:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1562 == null)
         {
            var_1562 = findChildByTag(TabContextController.const_1070) as IWindowContainer;
         }
         return var_1562;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_892 == null)
         {
            var_892 = findChildByTag(TabContextController.const_1069) as ITabSelectorWindow;
            if(var_892 != null)
            {
      ...
      {
         return !!var_748 ? selector.iterator : null;
      }
