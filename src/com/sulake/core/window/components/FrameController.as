package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_725:String = "margin_top";
      
      private static const const_1021:String = "_HEADER";
      
      private static const const_728:String = "margin_right";
      
      private static const const_1023:String = "_SCALER";
      
      private static const const_1022:String = "_TITLE";
      
      private static const const_1024:String = "_CONTENT";
      
      private static const const_726:String = "margin_left";
      
      private static const const_727:String = "margin_bottom";
      ...
      private var var_1094:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_726,_loc3_.left,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(const_725,_loc3_.top,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(const_728,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
         _loc1_.push(new PropertyStruct(const_727,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_214);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_183);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_196);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_183,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_183,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1094 == null)
         {
            var_1094 = findChildByTag(const_1021) as IHeaderWindow;
            if(!var_1094)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1022) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1023) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1339 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_17 == null)
         {
            var_17 = findChildByTag(const_1024) as IWindowContainer;
            if(!var_17)
            {
