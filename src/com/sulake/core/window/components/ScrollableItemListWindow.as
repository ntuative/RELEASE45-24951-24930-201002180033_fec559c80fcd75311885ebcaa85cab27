package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_861:IItemListWindow;
      
      private var var_337:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_337)
         {
            var_337 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_337)
            {
               var_337.addEventListener(WindowEvent.const_236,scrollBarEventProc);
               var_337.addEventListener(WindowEvent.const_185,scrollBarEventProc);
            }
         }
         return var_337;
      }
      ...
      override public function dispose() : void
      {
         if(var_337)
         {
            var_337.removeEventListener(WindowEvent.const_236,scrollBarEventProc);
            var_337.removeEventListener(WindowEvent.const_185,scrollBarEventProc);
            var_337 = null;
         }
         if(var_861)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_861)
         {
            var_861 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_861;
      }
