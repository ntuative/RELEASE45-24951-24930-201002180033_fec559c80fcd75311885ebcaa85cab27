package com.sulake.core.window.components
{
   ...
   public class SelectableButtonController extends ButtonController implements ISelectableWindow
   {
            ...
            if(var_6)
            {
               if(!(var_6 is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc3_.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_176,this,null));
                        break;
                     }
      ...
      public function unselect() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_596,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
