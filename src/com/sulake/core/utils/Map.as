package com.sulake.core.utils
{
   ...
   public class Map extends Proxy implements IDisposable
   {
      ...
      {
         var _loc2_:Object = var_115[param1];
         if(_loc2_ == null)
         {
            return null;
         }
         ...
         if(_loc3_ >= 0)
         {
            ...
            var_206.splice(_loc3_,1);
            --_length;
         }
         delete var_115[param1];
         return _loc2_;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_115)
         {
            delete var_115[_loc1_];
         }
         _length = 0;
         var_24 = [];
         var_206 = [];
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         var_115[param1] = param2;
         var _loc3_:int = var_206.indexOf(param1);
         if(_loc3_ == -1)
         {
            var_24[_length] = param2;
            var_206[_length] = param1;
            ++_length;
         }
         else
         {
