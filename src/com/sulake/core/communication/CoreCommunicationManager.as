package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1617:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_357)
         {
            _loc10_;
            if(var_357[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_613[_loc3_];
      ...
      {
         if(param1 == null || var_357 == null)
         {
            return null;
         }
         return var_357[param1] as IConnection;
      }
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_357)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_827:
               _loc3_ = new SocketConnection(param1,this,var_1617);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_357[param1] = _loc3_;
         return _loc3_;
      }
