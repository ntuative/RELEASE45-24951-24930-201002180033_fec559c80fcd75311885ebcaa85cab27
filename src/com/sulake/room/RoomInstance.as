package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_118:IRoomRendererBase;
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(var_208.getValue(_loc2_) != null)
         {
            _loc3_ = var_208.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < var_208.length)
            {
               _loc3_ = var_208.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_118 != null)
            {
               var_118.feedRoomObject(_loc5_,String(param3));
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            if(var_118)
            {
               var_118.removeRoomObject(param1,String(param2));
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  var_118.feedRoomObject(_loc7_,String(_loc4_));
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(var_208.getValue(_loc2_) != null)
         {
            return var_208.getValue(_loc2_) as IRoomObjectManager;
         }
         if(_container == null)
         {
            return null;
      ...
      {
         return var_208.getKeys();
      }
      
      protected function getObjectManager(param1:int) : IRoomObjectManager
      {
         return var_208.getValue(String(param1)) as IRoomObjectManager;
      }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(var_118)
                  {
                     var_118.removeRoomObject(_loc6_,String(param1));
                  }
               }
               _loc4_++;
            }
