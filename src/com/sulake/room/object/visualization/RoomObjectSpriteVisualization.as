package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      {
         if(param1 >= 0 && param1 < var_156.length)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_156 != null)
         {
            while(false)
            {
               _loc1_ = var_156[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_156.length > param1)
         {
            _loc2_ = var_156["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
