package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_487:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_488 = [];
         var_458 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_276,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_344,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_487.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_487 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_487 != null)
         {
            return var_487.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_487.createRoomObjectLogic(_loc18_);
