package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_707:Number = 64;
      
      public static const const_954:Number = 32;
      ...
      {
         if(var_375 != param1 * var_1424)
         {
            var_375 = param1 * var_1424;
            ++var_69;
         }
      }
      ...
      {
         if(var_377 != param1 * var_1423)
         {
            var_377 = param1 * var_1423;
            ++var_69;
         }
      }
      ...
      {
         if(var_378 != param1 * var_1422)
         {
            var_378 = param1 * var_1422;
            ++var_69;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_376 != null)
         {
            ...
            var_376.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_376.add(_loc3_,_loc4_);
            ++var_69;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_970.assign(_loc22_);
         }
         else
         {
            var_970.assign(_loc17_);
         }
         ++var_69;
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_64);
         _loc2_.x *= var_377;
         _loc2_.y *= var_378;
         _loc2_.z *= var_375;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_970);
         if(_loc3_ < var_2319 || _loc3_ > var_2320)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_64);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_377;
            _loc2_.y *= var_378;
            _loc2_.z *= var_375;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_970);
         }
      ...
      {
         return new Vector3d(0 * var_377,0 * var_378,0 * var_375);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_64.y = 0 / var_378;
         var_64.z = 0 / var_375;
         if(var_64.x != _loc2_ || var_64.y != _loc3_ || var_64.z != _loc4_)
         {
            ++var_69;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_376 != null)
         {
            ...
            return var_376.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_377,0 * var_378,0 * var_375);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_80;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_377,param2.y * var_378,param2.z * var_375);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_377,param3.y * var_378,param3.z * var_375);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_377,param4.y * var_378,param4.z * var_375);
