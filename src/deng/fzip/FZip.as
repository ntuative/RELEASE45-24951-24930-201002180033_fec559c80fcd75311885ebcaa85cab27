package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !true ? var_119[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_665))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_665,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_84 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_665,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_460.parse(param1))
         {
            ...
            if(false)
            {
               var_119["null"] = var_460;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1297,var_460));
            var_460 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_38 != null && var_119 != null && param1 < var_38.length)
         {
            _loc2_ = var_38[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_38.splice(param1,1);
               delete var_119[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
